                      ...
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 24px; mso-line-height-rule: exactly; line-height: 30px; font-weight: 700;color: #302f35;">
                          	Respected '.$pname.' Assalamualaikum!
                          </td>
                        </tr>
                        <tr>
                          <td height="20" style="height: 20px; line-height:20px;"></td>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                ...
                                We just recived your complaint. Please give us 24hs time to produce feedback.<br><br><strong>Complaint Details:</strong>
                                <br><br><strong>Account Name: </strong>'.$sname.'<br><strong>Department Name: </strong>'.$tname.'<br><br><strong>Complaint Discription: </strong><br>'.$msg.'<br><br>
                                We have a 24/7 help desk that you can call in case you need more assistance. Our staff will be more than willing to assist you with your needs.<br><br>
...
<strong>Admin '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email1.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
    ...
    if (!$mail->send()) {
        ...
        header(
			 	"Location: complaint-sms?name=".$pname."&msg=".$msg."");
