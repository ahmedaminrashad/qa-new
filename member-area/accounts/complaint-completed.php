								...
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li>
											...
											<span class="badge badge-success"> <?php echo pen_com("$tt"); ?> </span> PENDING </a>
										</li>
										<li class="active">
											<a href="complaint-completed">
											<span class="badge badge-success badge-active"> <?php echo com_com("$tt"); ?> </span> CLEARED </a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-helper">Complaints:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase">CLEARED (<?php echo com_com("$tt"); ?>)</span>
								</div>
							</div>
							<!-- end PROJECT HEAD -->
								...
								<div class="row">
									<div class="">
										<div class="scroller" style="max-height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											...
											<?php 
// sending query
$result = mysql_query("SELECT * FROM complaint WHERE cn_id = '2' AND parent_id = '$tt' ORDER BY com_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
													...
													<div class="todo-tasklist-item-text">
														 <strong>COMPLAINT:</strong> <?php echo $complaint; ?><br><span class="todo-tasklist-date"><i class="fa fa-calendar"></i> <?php echo $dateos; ?> </span>
													</div>
													<div class="todo-tasklist-item-text">
														 <strong><?php echo teacher("$res_id"); ?>:</strong> <?php echo $res; ?><br><span class="todo-tasklist-date"><i class="fa fa-calendar"></i> <?php echo $res_date; ?> </span>
													</div>
												</div>
												<?php 	
		$i++;		
