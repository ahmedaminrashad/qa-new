...
<input type="hidden" id="hidden_pdept_id" name="hidden_p_pdept_id"  value="<?PHP echo trim($_POST['hidden_pdept_id']); ?>" />
                <input type="hidden" id="hidden_dept" name="pti" value="<?PHP echo $pnid; ?>"/>
						...
						<h3><b><span class="label label-warning">Please select one or more invoices to pay by click on PAY NOW BUTTON</span></b></h3>
						<h3><button type="submit" class="btn red btn-xs">Pay Now</button></h3>
