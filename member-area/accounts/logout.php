...
Version: 4.1.0
Author: KeenThemes
Website: http://www.keenthemes.net/
Contact: support@keenthemes.net
Follow: www.twitter.net/keenthemes
Like: www.facebook.net/keenthemes
				...
				<div class="col-md-12">
					...
					Click Below to Login Again.</h3>
						<div class="auto-style1">
															...
															<a href="parents-home" class="btn blue"><i class="fa fa-user"></i> 
															Login</a>
						</div>
					</div>
