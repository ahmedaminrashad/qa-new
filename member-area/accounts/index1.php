...
if($isLogin){
 header("Location: parents-home?username=". $_SESSION['is']['username']);
}
?>
<?php
  error_reporting(0);
...
setcookie(Key_my_site, $_POST['userpass']);	
//then redirect them to the members area 

if($info['dept_id'] == '1002'){
		session_start();
		...
		$session = "1";	
   header("Location: parents-home?username=". $_POST['username']);  
				   }
...
<body>
    ...
    <main>
            ...
            <div id="LoginPage" style="background: #00613F;margin-top: 0px; height: 100vh;background-size: cover;" class="col-12">
                ...
                <div class="orSignup  col-12">
                             ...
                             <div class="btnSignLogin">
                                ...
                                <div class="btnSignLogin">
                                    <a href="https://qarabic.com/#request">Register Now</a>
                                </div>
                            </div>
            </div>
