...
?>
							...
							<td>
                                ...
                                <input type="image"  style="height: 6vh;" src="https://quransquare.com/resources/newassets/images/paypal-button@2x.png"
                                        name="submit" class="wp_cart_checkout_button"
                                        alt="Make payments with PayPal - it\'s fast, free and secure!" />
                                
                                <input type="hidden" name="return" value="https://quransquare.com/member-area/accounts/payment-done.php" />
