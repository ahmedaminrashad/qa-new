...
?>
								<li class="timeline-<?php if ($pinida == 1){ echo 'yellow'; } elseif ($pinida == 2){ echo 'green'; }?>">
									...
									<div class="timeline-icon">
										<i class="fa fa-<?php if ($pinida == 1){ echo 'history'; } elseif ($pinida == 2){ echo 'thumbs-o-up'; }?>"></i>
									</div>
									<div class="timeline-body">
										<h2><?php echo $tname; ?></h2>
										<div class="timeline-content">
											<strong><?php echo $pname; ?> <i class="fa fa-arrow-right"></i></strong> <?php echo $complaint; ?>											
											</div>
									</div>
								</li>
								<?php 	
