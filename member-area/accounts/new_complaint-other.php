   ...
   if (isset($_POST['cmdSubmit'])) 
  	{ 		
			...
			mysql_query ("INSERT INTO complaint(teacher_id, parent_id, issue, teacher_name, student_name, student_id, date1, time, parent_name, type)
					VALUES('0','$pnam','" . mysql_real_escape_string($msg) . "', '$ptname', '$paname', '0', '$date', '$time', '$paname', '$ptaype')") or die(mysql_error()); 
 		header(
			 	"Location: complaint-email-other?name=".$paname."&email=".$pemail."&teacher=".$ptname."&student=".$paname."&msg=".$msg."");
				}
?>
