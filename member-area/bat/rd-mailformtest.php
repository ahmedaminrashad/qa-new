...
try {
   ...
   header("Location: https://quransquare.com/member-area/admin/welcome-rigster.php?email=".$_REQUEST['email'].'&&name='.$_REQUEST['name']);
...
$new_message ='gender : '.$_REQUEST['gender_slider'].'<br>TimeZone : '.$_REQUEST['sTimeZoneCombo'];//.' <br>TimeZone : '.$_REQUEST['sTimeZone_slider'].$_REQUEST['sTimeZoneCombo'];
$new_website =1;
