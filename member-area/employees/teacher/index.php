...
<head>
    <meta charset="utf-8"/>
    <title>Quran Tutoring | Tutoring Managment System</title>
...
<div class="content">
    ...
    <form class="login-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        <div class="form-title">
            <span class="form-title">Please Enter Your login Details</span>
        </div>
...
<div class="copyright hide">
    &copy; Developed by Tarteel Technologies. <a href="http://www.tarteeltechnologies.com/" title="software development"
