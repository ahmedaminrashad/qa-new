...
//note feeds
$ridd = $_SESSION['is']['teacher_id'];
$result = mysql_query("SELECT * FROM note_student WHERE status = 2 AND teacher_id = '$ridd'");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($tnumberOfRows == 0) 
	...
	{
$announcements = '<span id="pulsate-regular" class="badge badge-default">'.$tnumberOfRows.'</span>';
}
?>
<?php
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								...
								<a href="comment-timeline-teacher-all">view all</a>
							</li>
							<li>
							</li>
						</ul>
...
Website: https://www.tarteeltechnologies.com/
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="https://qarabic.com"><img src="../../assets/admin/layout3/img/logo-default.png" alt="logo" class="logo-default"></a>
			</div>
			<!-- END LOGO -->
...
$main_menu='<!-- BEGIN MEGA MENU -->
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="teacher-schedule">Regular Schedule</a>
					</li>
					<li>
						<a href="teacher-student-list">List of Students</a>
					</li>
					<li>
					...
					<li class="menu-dropdown classic-menu-dropdown ">
						...
						Leave Applications <i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-left">
							<li class=" dropdown-submenu">
								<a href="leave-application">
								<i class="icon-wallet"></i>
								Create New Appliation </a>
							</li>
							<li class=" dropdown-submenu">
								<a href="leave-status">
								<i class="icon-plus"></i>
