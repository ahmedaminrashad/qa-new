...
?>							
								...
								<td><?php if ($mnp == 1){echo '<a href="leave_absent_mark?history_id='.$history_id.'&attend=5"><button type="button" style="width: 75px" class="btn blue btn-xs">Leave</button></a> <a class="allocation2" href="#allocation-c" data-toggle="modal" data-target="#allocation-c" data-id="'.$history_id.'"><button type="button" class="btn blue btn-xs" title="Add Schedule">Advance</button></a>';} ?>
								<?php if (($mnp == 4 OR $mnp == 5 OR $mnp == 6) && $restatus != 2) {echo '<a class="allocation1" href="#allocation-c" data-toggle="modal" data-target="#allocation-c" data-id="'.$history_id.'"><button type="button" style="width: 85px" class="btn blue btn-xs">Re-Schedule</button></a>'; } 
								elseif ($mnp == 8) {echo '<button type="button" style="width: 90px" class="btn red btn-xs disabled">Advanced</button>'; } ?>
								</td>
