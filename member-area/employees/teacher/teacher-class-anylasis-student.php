...
function class_monitor($var1, $var2, $var3){
    $date_start =$_REQUEST['date1'];
$date_end =$_REQUEST['date2'];
    $sql2="SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(`duration`))) AS total FROM class_history WHERE course_id = '$var1' AND status != 11 AND teacher_id = '$var2' AND monitor_id = '$var3' AND date_teacher >= '$date_start' AND date_teacher <= '$date_end'";
...
function class_monitor_num($var1, $var2, $var3){
    $date_start =$_REQUEST['date1'];
$date_end =$_REQUEST['date2'];
    $result = mysql_query("SELECT history_id FROM class_history WHERE course_id = '$var1' AND teacher_id = '$var2' AND status != 11 AND monitor_id = '$var3' AND date_teacher >= '$date_start' AND date_teacher <= '$date_end'");
if (!$result) 
	{
    die("Query to show");
	}
...
function class_paid($var1, $var2, $a)
{
    $date_start =$_REQUEST['date1'];
$date_end =$_REQUEST['date2'];
    $sql2="SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(`duration`))) AS total FROM class_history WHERE course_id = '$var1' AND status != 11 AND re_status != 2 AND teacher_id = '$var2' AND date_admin >= '$date_start' AND date_admin <= '$date_end' AND (monitor_id = 4 OR monitor_id = 9  OR monitor_id = 21)";
$res2 = mysql_query($sql2);
$totalRow = mysql_fetch_array($res2);
$total = $totalRow['total'];
if ($total != 0){echo $total;}
...
$sql2="SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(`duration`))) AS total FROM class_history WHERE course_id = '$var1' AND status != 11 AND teacher_id = '$var2' AND re_status != 2 AND date_teacher >= '$date_start' AND date_teacher <= '$date_end' AND (monitor_id = 4 OR monitor_id = 9  OR monitor_id = 21)";
$res2 = mysql_query($sql2);
$totalRow = mysql_fetch_array($res2);
$total = $totalRow['total'];
$hours=$total;
