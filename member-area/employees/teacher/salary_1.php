...
include("../includes/teacher_rights.php");  include("header.php");
  ...
  $tt_type = $_SESSION['is']['salary_type'];
?>
<?php
...
?>
								...
								<td>
									<a href="salary-details_<?php echo $tt_type; ?>?sal_id=<?php echo $sal_id; ?>"><button type="button" class="btn green btn-xs">See Details</button></a>
								</td>
							</tr>
							<?php 	
		$i++;		
