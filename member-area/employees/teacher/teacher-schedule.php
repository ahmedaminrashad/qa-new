	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Weekly <small>Regular Schedule</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
...
<?php 
// sending query
$result = mysql_query("SELECT * FROM TimeTable WHERE (TimeID >= $st1 AND TimeID <=$et1) OR (TimeID >= $st2 AND TimeID <=$et2) OR (TimeID >= $st3 AND TimeID <=$et3)");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
