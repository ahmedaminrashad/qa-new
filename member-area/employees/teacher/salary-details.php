...
echo $monthName; ?>-<?php echo $syear; ?>
			...
			<!-- BEGIN PAGE CONTENT INNER -->
				...
				<div class="portlet light">
								...
								<td><?php if ($t_type == 1) {echo $t_salary;} elseif ($t_type == 2) { echo $t_class; } elseif ($t_type == 3) { echo $t_hour; } elseif ($t_type == 4) {echo $t_slot;} else {echo '--';} ?></td>
								</tr>
								</tbody>
								</table>
								<table class="table table-bordered table-hover">
								...
								<td class="auto-style5"><b>Amount (EGP)</b></td>
								<td></td>
								...
								<tr class="info">
								<td><b><?php if ($t_type == 3) { echo 'Hours Earning'; } elseif ($t_type == 4) {echo 'Slab Earning';} else { echo 'Classes Earning'; } ?></b></td>
								<td class="auto-style5"><?php if ($t_type == 3) { echo number_format($t_hour, 2); } elseif ($t_type == 4) {echo number_format($t_slot, 2);} else { echo number_format($t_class, 2); } ?></td>
