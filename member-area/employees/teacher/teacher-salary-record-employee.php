					...
					<div class="portlet light">
						<div class="portlet-body">
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
// sending query
$result = mysql_query("SELECT teacher_salary.* , profile.* FROM teacher_salary,profile WHERE teacher_salary.teacher_id = $tech_id and profile.teacher_id = $tech_id ORDER BY salary_id DESC;");
$counter = 0;
if (!$result) 
	{
...
?>
								...
								<td>
									 <b><a href="salary-details-employees?sal_id=<?php echo $sal_id; ?>&month=<?php echo date('F-Y',strtotime($t_date)); ?>&teach_id=<?php echo $ttt_id; ?>"><?php echo date('F-Y',strtotime($t_date)); ?></a></b><br>
								    	<a href="salary-details-employees?sal_id=<?php echo $sal_id; ?>&month=<?php echo date('F-Y',strtotime($t_date)); ?>&teach_id=<?php echo $ttt_id; ?>"><button type="button" style="height: 27px; margin: 0 0 0 0;"  class="btn green btn-xs">See Details</button></a>
								</td>
