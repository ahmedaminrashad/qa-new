    ...
    if (isset($_POST['cmdSubmit'])) 
  	{ 		
			...
			mysql_query ("INSERT INTO test_results (course_id, teacher_id, m_id, y_id, test_date, test_time, test_discription, parent_id, dept_id, c_id, g_id, lan_id, tremark, time_name, phptime, man_id, test_status, makharij, noon_sakin, meem_sakin, qulqala, guuna, madda)
					VALUES('$as_id', '$at_id', '$am_id', '$ay_id', '$adat', '$atim', '" . mysql_real_escape_string($adis) . "', '$app_id', '2', '$ac_id', '$ag_id', '$al_id', '$apr_id', '$atn', '$apn', '$aman_id', '$sst', '1', '1', '1', '1', '1', '1')") or die(mysql_error()); 
					 header(
...
?>
				...
				do {  ?>
                    ...
                    <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Reading Details*</strong></label>
													<div class="col-md-9">
