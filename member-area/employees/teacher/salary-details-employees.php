...
$result = mysql_query("SELECT `profile`.*, `Gender`.`gender`, `employee_catagory`.`cat_name` FROM `profile`,`Gender`,`employee_catagory` WHERE profile.g_id=Gender.g_id and profile.cat_id=employee_catagory.cat_id HAVING teacher_id = '$pT'");
		if (!$result) 
			{
...
If ($numberOfRows == 0) 
	...
	$i=0;		
			...
			$t_to_class = MYSQL_RESULT($result,$i,"total_classes");
			$t_to_hours = MYSQL_RESULT($result,$i,"total_hours");
			//earning
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 Salary Detail for the month of <?php echo $smonth; ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- BEGIN PAGE CONTENT INNER -->
				...
				<div class="portlet light">
								...
								<td class="auto-style5"><b>Amount (<?php echo blocked('currency'); //if ($t_type == 3){//echo '$';} else{//echo 'Rs.';} ?>)</b></td>
								<td></td>
