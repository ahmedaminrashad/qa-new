...
if (!$result3) 
		...
		die("Query to show fields from table failed");
			...
			If ($numberOfRows == 0) 
				...
				{
				$i=0;
			$tzy = MYSQL_RESULT($result3,$i,"timezone_diff");
			$tzname = MYSQL_RESULT($result3,$i,"timezone_name");
				}
?>
<?php
$z = 48;
...
if (!$result1) 
		...
		echo "Teacher Time: <font color='#44B6AE'> <b>$teacher</b></font> <br>"; ?>
...
if (!$result1) 
		...
		die("Query to sailed");
			...
			echo "Studnet Time: <font color='#44B6AE'> <b>$teacher1</b></font> <br>";
			echo "Time-Zone: <font color='#44B6AE'> <b>$tzname ($tzy:00)</b></font>";
?>
</h5>
...
?>
								...
								<td>
									 <a href="teacher-schedule?pT=<?php echo $profile_no; ?>"><?php echo $tname; ?> (<?php echo $profile_no; ?>)</a>
								</td>
