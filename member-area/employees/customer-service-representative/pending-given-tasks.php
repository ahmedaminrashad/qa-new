...
function pending($var1, $var2, $var3){
  $result = mysql_query("SELECT * FROM task_creator WHERE clear = '$var1' AND to_person = '$var2' AND status = '$var3'");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Given <small>Task Management</small></h1>
			</div>
			<!-- END PAGE TITLE -->
		</div>
	</div>
							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li class="active">
											<a href="pending-given-tasks">
											<span class="badge badge-success badge-active"> <?php echo pending("1","$ID","1"); ?> </span> ACTIVE </a>
										</li>
										<li>
											<a href="closed-given-tasks">
											<span class="badge badge-success"> <?php echo pending("2","$ID","1"); ?> </span> CLOSED </a>
										</li>
										<li>
											<a href="awaiting-given-tasks">
											<span class="badge badge-success"> <?php echo pending("1","$ID","2"); ?> </span> AWAITING </a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-helper">Tasks:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase">ACTIVE for your responce (<?php echo pending("1","1"); ?>)</span>
								</div>
							</div>
							<!-- end PROJECT HEAD -->
								...
								<div class="row">
									<div class="">
										<div class="scroller" style="max-height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											...
											<?php 
// sending query
$result = mysql_query("SELECT * FROM task_creator WHERE clear = '1' AND to_person = '$ID' AND status = '1' ORDER BY task_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
													...
													<div class="todo-tasklist-controls pull-right">
														<a href="task-string-given?task=<?php echo base64_encode($taskid); ?>"><button type="button" class="btn red btn-xs">Open String</button></a>
														</div>
												</div>
												<?php 	
		$i++;		
