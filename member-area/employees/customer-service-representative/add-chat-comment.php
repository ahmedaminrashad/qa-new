...
$acom =$_REQUEST['comment'];
			...
			mysql_query ("INSERT INTO comment (parent_id, user_id, date, time, username, parent_name, manager_id, comment)
					VALUES('$apid','$auid','$adate','$atime','$auname','$apname','$apman','$acom')") or die(mysql_error()); 					
 
 if(mysql_query){
 $result = mysql_query("SELECT * FROM sms_status WHERE service_id = 1");
 if (!$result) 
			{
