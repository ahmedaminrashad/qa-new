								...
								<div class="row">
									...
									<div class="col-md-9">
										<div class="row">
											...
											<ul class="list-inline">
											<li>
														<a href="save-student?t_id=<?php echo $pid; ?>&cp_id=<?php echo $pc11; ?>&man_id=<?php echo $pman; ?>&trial_id=<?php echo $active_s; ?>&time_id=<?php echo $ptz; ?>&csr_id=<?php echo $t_csr; ?>"><button type="button" class="btn blue btn-xs"><i class="fa fa-plus"></i> Add New Student</button></a>
													</li>
													<li>
...
?>
														...
														<tr>
															...
															<td>
																<a href="paid.php?payment_id=<?php echo $pidy; ?>" onclick="return confirm('<?php echo "You are about to mark this invoice paid. Please confirm your action."; ?>');"><?php if ($s == 1){echo '<button type="button" class="btn red btn-xs">Mark</button>'; }?></a><?php if ($s == 2){ echo '<button type="button" class="btn green btn-xs">Paid</button>'; } ?>
															</td>
															<td><a href="edit-invoice?pT=<?php echo base64_encode($pidy); ?>&link=<?php echo base64_encode($link); ?>"><button type="button" class="btn yellow btn-xs"><i class="fa fa-edit"></i></button></a></td>
															<td><a href="delete-invoice?pT=<?php echo $pidy; ?>"><button type="button" class="btn red btn-xs"><i class="fa fa-ban"></i></button></a></td>
														</tr>
														<?php
														$i++;		
		}
																...
																<li>
																	<div class="col1">
																		<div class="cont">
																			...
																			<div class="cont-col2">
																				<div class="desc">
																					 <?php echo $acom; ?> (<?php echo tech($auid); ?>)
																				</div>
																			</div>
																		</div>
																	</div>
									...
									<div class="portlet-body form">
										...
										<form action="add-chat-comment" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												...
												<input type="hidden" value="<?php echo $ID; ?>" name="u_id" id="u_id" class="form-control input-circle"></input>
