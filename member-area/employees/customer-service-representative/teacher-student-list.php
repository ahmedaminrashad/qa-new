...
?>
								...
								<td><a class="add" href="#invoice" data-toggle="modal" data-target="#invoice" teacher-id="<?php echo $pT; ?>" student-id="<?php echo $Course_ID; ?>" name="<?php echo $course_yrSec; ?>"><span class="label label-sm label-warning" title="Re-Schedule"><i class="fa fa-history"></i></span></a></td>
							</tr>
							<?php 	
		$i++;		
		}
