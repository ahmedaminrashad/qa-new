					...
					<div class="tabbable tabbable-custom tabbable-noborder">
						...
						<div class="tab-content">
							<div id="tab_2_2" class="tab-pane active">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM dept WHERE type_id = 1 ORDER BY position_id ASC;");
$counter = 0;
if (!$result) 
	{
...
?>
							...
							<div id="tab_1_3" class="tab-pane">
								<div class="row booking-results">
									<?php 
// sending query
$result = mysql_query("SELECT * FROM dept WHERE type_id = 3 ORDER BY position_id ASC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
							...
							<div id="tab_3_3" class="tab-pane">
								<div class="row booking-results">
									<?php 
// sending query
$result = mysql_query("SELECT * FROM dept WHERE type_id = 2 ORDER BY position_id ASC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
