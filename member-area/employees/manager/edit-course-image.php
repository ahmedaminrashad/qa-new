...
define('DB_SERVER_USERNAME', 'tarteele_raj');
define('DB_SERVER_PASSWORD', '5506729*');
define('DB_DATABASE', 'tarteele_ss');
...
if (isset($_POST["sub1"]) || isset($_POST["sub2"])) {
  ...
  if (count($_FILES["user_files"]) > 0) {
    ...
    $sql = "UPDATE dept SET image_name = :img WHERE dept_id = '$acid'";
    $stmt = $DB->prepare($sql);
	...
	if (!$result) 
		...
		die("Query to show fields from table failed");
			...
			//echo 'Sorry No Record Found!';
				...
				{
				$i=0;
			$aaimg = MYSQL_RESULT($result,$i,"image_name");

			}
?>

										<div class="form-body">
										<form name="f1" action="edit-course-image?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>a" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong></strong></label>
															<div class="col-md-4">
																<img src="../../uploads/<?php echo $aaimg; ?>"  height="50%" width="50%" alt=""/>	
														</div>
													</div>
												<div class="form-group">
															<label class="control-label col-md-3">
