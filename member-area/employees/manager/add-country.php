								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<div class="form-group">
															...
															<div class="col-md-9">
															<input required type="text" placeholder="e.g. Pakistan" name="con_name" id="con_name" class="form-control input-circle">															</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Country Abbreviation</strong></label>
													<div class="col-md-4">
														<input required type="text" placeholder="e.g. PAK" name="con_ab" id="con_ab" class="form-control input-circle">
													</div>
												</div>
