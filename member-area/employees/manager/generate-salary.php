...
if (isset($_POST['genSubmit'])) 
  	{ 		
		 	...
		 	$add_date= $_POST['date'];
		 	$link= $_POST['link_id'];
			mysql_query ("INSERT INTO teacher_salary (teacher_id, date, monthly_salary, company_returns, performance, residence_all, fine, leave_duc, advance_duc, tax, type, fine_reduc)
					VALUES('$tech_id', '$add_date', '$salary', '$returns', '$bouns', '$rent', '$fine', '$leave', '$advance', '$tax', '1', '$fine_reduc')") or die(mysql_error()); 
								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<div class="form-group">
												...
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Monthly Salary</strong></label>
													<div class="col-md-4">
