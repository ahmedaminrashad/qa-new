							...
							<div class="tab-pane active" id="tab_1_1">
								<div class="row">
									<div class="col-md-3">
										...
										<!--	<li>
												<a href="create-monthly-invoice-ins?pids=<?php echo $pid; ?>&frr=<?php echo $pfe; ?>&cur=<?php echo $cu; ?>&link=<?php echo $link; ?>">
										...
										<!--	<li>
											...
											<li>
												<?php if ($active_s != 17){ echo '<a data-toggle="modal" href="#suspension"><i class="fa fa-close"></i> Suspend Classes</a>'; } else { echo ''; } ?>
												<?php if ($active_s == 17){ echo '<a href="un-suspend-classes?t_id='.$pid.'&link='.$link.'"><i class="fa fa-check"></i> Un-Suspend Classes</a>'; } else { echo ''; } ?>
											</li>
										</ul>
									</div>
									<div class="col-md-9">
