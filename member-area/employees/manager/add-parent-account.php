...
if ($conflict != true){
			mysql_query ("INSERT INTO account(parent_name, email, username, userpass, c_id, telephone, mobile, skype, fee, city, m_id, currency_id, mode_id, date, belong, timezone, trial_date, invoice_type, payment_cycle)
					VALUES('$pname','$pemail','$puser','$ppass','$pcon','$ptele','$pmob','$pskype','$pfee','$pcity','$pman','$pcur','$pmod','$pd','$bl','$tz','$triald','$ainvoice','$acycle')") or die(mysql_error()); 
				if(mysql_query){
				mysql_query("UPDATE new_request SET status = 5 WHERE request_id = '$areq'");
 		header(
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="date" class="form-control" placeholder="dd-mm-yy" name="trialdate" id="trialdate" required>
															</div>														</div>
													</div>
												</div>
												<!--/row-->
