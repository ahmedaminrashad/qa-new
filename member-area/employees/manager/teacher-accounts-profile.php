									...
									<div class="col-md-9">
										<div class="row">
											<div class="profile-info">
												...
												<h1><a data-target="#level" data-toggle="modal"><?php if ($rg_level == 1){echo '<span class="label label-sm label-danger">Class A</span>';} elseif ($rg_level == 2){echo '<span class="label label-sm label-warning">Class B</span>';} else {echo '<span class="label label-sm label-success">Class C</span>';} ?></a></h1>
...
?>
					...
					<div class="modal fade" id="fine" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<!--fine modal end-->					<!--performance modal start-->
  ...
  <?php } while ($row = mysql_fetch_assoc($result)); ?>
					...
					<div class="modal fade" id="bank" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Add Salary for <?php echo $tname; ?>
										</div>
										<div class="tools">
											<a href="javascript:;" class="collapse">
											</a>
