...
if (isset($_POST['cmdSubmit'])) 
  	{ 	
			...
			mysql_query( "UPDATE course SET Teacher = '$con_t' where course_id = '$con_c'") or die(mysql_error()); 
			
			mysql_query( "UPDATE sched SET Teacher = '$con_t' where course_id = '$con_c'") or die(mysql_error());
