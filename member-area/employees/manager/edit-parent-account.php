...
?></b></font></h3>
												...
												<div class="row">
													...
													<input type="hidden" class="form-control" value="<?php echo $pfe; ?>" name="pfee" id="ppass0">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															Time Zone</label>
															<div class="col-md-9">
															<select required class="form-control" name="ptime"  id="ptime" onchange="javascript: return optionList49_SelectedIndex()">
															<?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
