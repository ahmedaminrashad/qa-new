<?php
  require ("../includes/dbconnection.php");
    ...
    $date = date('F j, Y',strtotime($row['doj']));
?>
<!DOCTYPE html>
<!-- 
				...
				<div class="col-md-12">
					...
					<p class="auto-style1"><img src="../assets/logo1.jpg" alt="logo" class="logo-default" height="99" width="97"></p>
						<div class="portlet-body">
							...
							<p>This AGREEMENT, entered into this <?php echo $date; ?>, between TARTEEL TECHNOLOGIES (SMC-PVT) LTD and <?php echo $tname; ?> S/O <?php echo $fname; ?>, holding CNIC No: <?php echo $cnic; ?>,</p>
