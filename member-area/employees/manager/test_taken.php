	...
	while ($i<$numberOfRows)
		{		
			...
			?>
								...
								<td><a href="student_results?course_id=<?php echo base64_encode($pcourse); ?>"><button type="button" class="btn blue btn-xs">See Test Results</button></a></td>
							</tr>
							<?php 	
		$i++;		
		}
