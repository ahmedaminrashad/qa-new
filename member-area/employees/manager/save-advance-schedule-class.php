    ...
    die("Database connection failed. Please contact the administrator.");
		...
		echo $history;
			...
			mysql_query ("INSERT INTO class_history(parent_id, course_id, teacher_id, atime_s_id, stime_s_id, time_s_id, dept_id, adept_id, status, date_admin, date_student, date_teacher, type, le_date_admin, le_date_teacher, le_date_student)
					VALUES('$p_id','$s_id','$t_id','$a_timee','$s_timee','$t_timee','$d_id', '$ad_id', '19', '$adate', '$sdate', '$tdate', '11','$leadate','$letdate','$lesdate')") or die(mysql_error()); 
			mysql_query("UPDATE class_history SET re_status = 1, re_date_admin = '$adate', re_date_student = '$sdate', re_date_teacher = '$tdate', monitor_id = 8 WHERE history_id = $history") or die(mysql_error());
