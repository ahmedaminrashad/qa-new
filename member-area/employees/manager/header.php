...
if ($tnumberOfRows > 0){
$menu_csr= '<li><a href="../customer-service-representative/home"><i class="icon-key"></i> Go As CSR </a></li>';
	}
...
$menu_teacher='<li>
								...
								<i class="icon-key"></i> Go As Teacher </a>
							</li>';
	}
...
$menu_manager='<li>
								...
								<i class="icon-key"></i> Go As Manager </a>
							</li>';
	}
...
$menu_senior='<li>
								...
								<i class="icon-key"></i> Go As Senior Manager </a>
							</li>';
	}
...
$menu_accounts='<li>
								...
								<i class="icon-key"></i> Go As Accountant </a>
							</li>';
	}
...
$menu_billing='<li>
								...
								<i class="icon-key"></i> Go to Billing Section </a>
							</li>';
	}
 $ID = $_SESSION['is']['teacher_id'];
...
$result = mysql_query("SELECT * FROM announcement WHERE (ann_cat = 4 or ann_cat = 17) and ann_date <= '$trial_time' AND ann_end >= '$trial_time'");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
...
$result = mysql_query("SELECT * FROM account WHERE active = 11 and m_id = $ID and trial_date < '$trial_time'");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
$result = mysql_query("SELECT * FROM account WHERE active = 11 and m_id = $ID");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
$result = mysql_query("SELECT * FROM account WHERE active = '7' and m_id = $ID and leave_date < '$trial_time'");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
$result = mysql_query("SELECT * FROM account WHERE active = '7' and m_id = $ID");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
			...
			<div class="top-menu">
				...
				<!-- BEGIN NOTIFICATION DROPDOWN -->
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong>'.$announcements.' Complaints </strong>.</h3>
...
$main_menu='<!-- BEGIN MEGA MENU -->
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="parent-accounts">Families</a>
					</li>
					<li>
