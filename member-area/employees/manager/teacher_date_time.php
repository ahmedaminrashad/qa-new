...
echo $rnumberOfRows; ?>
				...
				<a href="test_created"><div class="tile bg-purple-seance">
					<div class="tile-body">
...
echo $anumberOfRows; ?>
				...
				<a href="test_remaining"><div class="tile bg-purple-seance">
					<div class="tile-body">
...
echo $lnumberOfRows; ?>
				...
				<a href="test_refused"><div class="tile bg-purple-seance">
					<div class="tile-body">
...
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<span class="label label label-success">'.$new_date.'</span>'; } ?>
						<span class="label label label-success"><?php echo date("g:i a", strtotime($time_id)); ?></span>
...
If ($tnumberOfRows2 == 0){
 ...
 ?></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$date_id' AND teacher_id = '$tech_id' and start_time_A <= '$time_id' and end_time_A > '$time_id' ORDER BY start_time_A");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
