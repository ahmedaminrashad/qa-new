	...
	$i=0;
			...
			$artime = MYSQL_RESULT($result,$i,"read_time");
										...
										<div class="form-group">
												...
												<input type="hidden" class="form-control" value="<?php echo $pid111; ?>" name="rpid111" id="rpid111">
												<input type="hidden" class="form-control" value="<?php echo $link; ?>#tab_1_44" name="link1" id="link1">
