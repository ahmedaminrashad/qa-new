	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Generate <small>Monthly Salary</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 You are Generation Monthly Salary
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Please Select Month &amp; Year
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="monthly-salary-record" method="GET" class="form-horizontal">
											<div class="form-body">
