				...
				<div class="portlet-body">
					<div class="timeline">
						...
						<div class="timeline-item">
							...
							<div class="timeline-body bg-red-pink">
							...
							<div class="timeline-body">
								...
								<div class="timeline-body-head">
									<div class="timeline-body-head-caption">
										...
										<?php if ($status == 1){ echo '<span class="font-red">Action Pending from your side...</span>'; } elseif ($status == 2){ echo '<span class="font-green">No Action Required from your side...</span>';} ?></span>
									</div>
...
<div class="modal fade" id="note" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="add-new-comment-given-task" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												...
												<input type="hidden" value="<?php echo $to_p; ?>" name="usertk_id" id="usertk_id" class="form-control input-circle">
