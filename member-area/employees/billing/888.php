...
?>
								...
								<td><?php if ($sttat == 1){ echo "<a href='paid.php?payment_id=$pid'><button type='button' class='btn red btn-xs'>Mark</button></a>"; } else { echo '<button type="button" class="btn green btn-xs">Paid</button>'; } ?></td>
							</tr>
							<?php 	
		$i++;		
		}
