...
?>
<?php
$db = new mysqli('localhost',$username_db,$userpass_db,$name_db);
...
?>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" value="N-A" readonly>															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
				...
				do {  ?>
                      ...
                      <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<div class="row">
													...
													<div class="col-md-9">
														<select required class="form-control" name="ebank"  id="ebank" onchange="javascript: return optionList43_SelectedIndex()">
                      <?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
				...
				do {  ?>
                      ...
                      <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<input type="hidden" class="form-control" value="0" name="avou_id" id="avou_id">
