...
$menu_teacher='<li>
								...
								<i class="icon-action-undo"></i> Teacher </a>
							</li>';
	}
...
$menu_senior='<li>
								...
								<i class="icon-lock"></i> Senior Manager </a>
							</li>';
	}
...
$result = mysql_query("SELECT * FROM announcement WHERE (ann_cat = 8 or ann_cat = 17) and ann_date <= '$trial_time' AND ann_end >= '$trial_time'");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						'.$menu_billing.'
							<li>
								...
								<i class="icon-wallet"></i> Salary Rercord </a>
							</li>
							<li>
								<a href="logout">
...
$main_menu='<!-- BEGIN MEGA MENU -->
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li>
						<a href="list-of-voucher">Home</a>
					</li>
					<li class="menu-dropdown classic-menu-dropdown ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
						Vouchers <i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-left">
							...
							<li class=" dropdown-submenu">
								...
								<i class="icon-plus"></i>
								Add Reciept Voucher </a>
							</li>
							<li class=" dropdown-submenu">
								<a href="add-voucher-payment-salary">
								<i class="icon-plus"></i>
								Add Salary Voucher </a>
							</li>
						</ul>
					</li>
					<li class="menu-dropdown classic-menu-dropdown ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
						Adjustment Accounts <i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-left">
							<li class=" dropdown-submenu">
					...
					<li class="menu-dropdown classic-menu-dropdown ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
						On-Going Reports <i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-left">
							<li class=" dropdown-submenu">
								<a href="receipt-payment">
								<i class="icon-wallet"></i>
								Receipt & Payment Monthly </a>
							</li>
							<li class=" dropdown-submenu">
								<a href="receipt-payment-year">
								<i class="icon-wallet"></i>
								Receipt & Payment Yearly </a>
							</li>
							<li class=" dropdown-submenu">
								<a href="cash-book">
								<i class="icon-wallet"></i>
					...
					<li>
						<a href="generate-reports">Generate Report</a>
					</li>
					<li><li class="menu-dropdown mega-menu-dropdown ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						Other Options <i class="fa fa-angle-down"></i>
						</a>
									...
									<div class="row">
										<div class="col-md-4">
											<ul class="mega-menu-submenu">
												...
												<li>
													<a href="add-account-head" class="iconify">
													<i class="icon-cursor-move"></i>
													Add New Head</a>
												</li>
												<li>
													<a href="add-vendor" class="iconify">
													<i class="icon-cursor-move"></i>
													Add New Vendor</a>
												</li>
											</ul>
										...
										<div class="col-md-4">
											<ul class="mega-menu-submenu">
												...
												<li>
													<a href="list-of-account-head" class="iconify">
													<i class="icon-cursor-move"></i>
													List of Heads </a>
												</li>
												<li>
													<a href="list-of-vendor" class="iconify">
													<i class="icon-cursor-move"></i>
													List of Vendors </a>
												</li>
											</ul>
					...
					<li class="menu-dropdown classic-menu-dropdown ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
						Leave <i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-left">
							<li class=" dropdown-submenu">
								<a href="leave-application">
								Create Leave Application </a>
							</li>
							<li class=" dropdown-submenu">
								<a href="leave-status">
								Leave Status </a>
