  ...
  include("header.php");
    if (isset($_POST['cmdSubmit'])) 
  	{ 		
		 	...
		 	$vbank= $_POST['bank_id'];
			mysql_query ("INSERT INTO voucher (voucher_num, cheque_num, date, type_id, bank_id)
					VALUES('$vun','$chn','$vdate','2','$vbank')") or die(mysql_error()); 
					 header(
						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>You are adding new PAYMENT voucher
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal form-row-seperated">
										<input type="hidden" class="form-control" name="vou_type"  id="vou_type" value="2">
