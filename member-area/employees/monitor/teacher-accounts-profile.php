...
If ($tnumberOfRows == 0){
   ...
   $ptec =base64_decode($_GET["profile_no"]);
	$result =  mysql_query("SELECT * FROM `profile`,`marital`,`Gender`,`S1time`,`S2time`,`timestart`,`Stime`,`employee_catagory` WHERE profile.ms_id=marital.ms_id and profile.g_id=Gender.g_id and profile.st1=timestart.time_s_id and profile.st2=Stime.stime_s_id and profile.et1=S1time.stime_s_id1 and profile.et2=S2time.stime_s_id2 and profile.cat_id=employee_catagory.cat_id HAVING teacher_id = $ptec");
if (!$result) 
		{
		die("Query to show fields from table failed");
		}
									...
									<div class="col-md-9">
										<div class="row">
											...
											<li>
													...
													<li>
														Skype: <font color="#44B6AE"> <b><?php echo $skype; ?></b></font>
													</li>
													<li>
														Skype-Pass: <font color="#44B6AE"> <b><?php echo $skype_p; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
											...
											<ul class="list-inline">
											<li>
												<a href="under-taking-teacher-print?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>&tech_add=<?php echo $add; ?>&tech_mat=<?php echo $mat; ?>"><button type="button" class="btn yellow btn-xs">Print Teacher Undertaking</button></a>
													</li>
													<li>
												<a href="under-taking-csr-print?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>&tech_add=<?php echo $add; ?>&tech_mat=<?php echo $mat; ?>"><button type="button" class="btn yellow btn-xs">Print CSO Undertaking</button></a>
													</li>
													<li>
												<a href="bank-account-letter-print?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>&tech_add=<?php echo $add; ?>&tech_mat=<?php echo $mat; ?>"><button type="button" class="btn yellow btn-xs">Print Account Opening Request</button></a>
													</li>
													</ul>
											</div>
											<!--end col-md-8-->
...
?>
									...
									<div class="portlet-body form">
										...
										<form action="edit-bank-teacher" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Class Rate</strong></label>
															<div class="col-md-7">
															<input type="text" name="class_r" id="class_r" class="form-control input-circle" value="<?php echo $crate; ?>" required></input>
															</div>
												</div>
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>CSR Rate</strong></label>
															<div class="col-md-7">
															<input type="text" name="csr_r" id="csr_r" class="form-control input-circle" value="<?php echo $csrrate; ?>" required></input>
															</div>
												</div>
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Residence Allow.</strong></label>
															<div class="col-md-7">
  ...
  <?php } while ($row = mysql_fetch_assoc($result)); ?>
					...
					<div class="modal fade" id="salary" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="generate-salary" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Month</strong></label>
  ...
  <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<input type="hidden" value="<?php if ($cat == 7 OR $cat == 8) { echo '2'; } else { echo '8'; } ?>" name="ac_cat" id="ac_cat" class="form-control input-circle"></input>
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="submit" name="cmdSubmit" class="btn btn-circle blue">
