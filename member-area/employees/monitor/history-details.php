...
?>
			...
			<?php if ($restatus == 1) { echo '<a href="history-delete?history_id='.$hid.'"><button type="button" class="btn red btn-xs">Delete</button></a> <a href="re-schedule-class?adateid='.$a_date.'&tdateid='.$t_date.'&sdateid='.$s_date.'&Course_ID='.$stur_course_id.'&tech='.$tech_id.'&studentName='.$student.'&link='.base64_encode($link).'&history_id='.$hid.'&dept_id='.$r_course_id.'&adept_id='.$a_course_id.'"><button type="button" class="btn blue btn-xs" title="Add Schedule">Re-Schedule</button></a> <a href="leave_absent_mark?history_id='.$hid.'&attend=5"><button type="button" style="width: 75px" class="btn yellow btn-xs">Leave</button></a>'; } ?></b></font>
									</h4>
