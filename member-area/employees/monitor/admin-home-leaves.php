	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Admin Home<small> Students on leave</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
...
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<span class="label label label-success">'.$new_date.'</span>'; ?> <span class="label label bg-blue-madison">Total Leaves</span></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND monitor_id = 5 ORDER BY atime_s_id;
  			");
if (!$result) 
	{
    die("Query to show fields from table failed");
