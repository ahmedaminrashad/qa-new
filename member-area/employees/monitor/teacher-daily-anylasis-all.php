...
$result = mysql_query("SELECT history_id FROM class_history WHERE date_admin = '$date_start' AND re_status != 2 AND (monitor_id = 4 OR monitor_id = 9 OR monitor_id = 6 OR monitor_id = 21)");
if (!$result) 
	{
    die("Query to show");
	}
