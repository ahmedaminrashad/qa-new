...
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<span class="label label label-success">'.$new_date.'</span>'; ?> <span class="label label bg-grey-cascade">Declined</span></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND monitor_id = 6 ORDER BY atime_s_id;
  			");
if (!$result) 
	{
    die("Query to show fields from table failed");
