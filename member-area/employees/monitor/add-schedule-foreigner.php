...
<?php echo $start_menu; ?>
<?php echo $search_bar; ?>
<?php echo $main_menu; ?><!-- BEGIN PAGE CONTAINER -->
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Add <small>Schedule</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
