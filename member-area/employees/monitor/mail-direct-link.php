                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;"><br><a href="https://www.2checkout.com/checkout/purchase?sid='.$account.'&total='.$fee.'&cart_order_id=10-2017&c_prod=5&id_type=2&lang=en&mode=new&fixed=Y&py_id='.$in_id.'" ><button class="button" style="vertical-align:middle"><span><b>PAY NOW</b></span></button></a></td>
                                    </tr>
                                  	<!-- #{EndInfo} -->                                    
                                  </table>
                                </td>
                              ...
                              <tr>
                                ...
                                Kindly Pay your invoice before/on due date. If you are unable to pay your invoice due to any reason, please inform us the date you will pay your invoice via email at <strong>accounts@saioi.net</strong> so that your classes remain continue without any inconvenience.<br>
