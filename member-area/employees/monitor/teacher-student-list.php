...
?>
								...
								<td><a href="add-re-schedule-class?Course_ID=<?php echo $Course_ID; ?>&tech=<?php echo $ptea; ?>&studentName=<?php echo $course_yrSec; ?>&link=<?php echo base64_encode($link); ?>&dept_id=<?php echo $dept_id; ?>&adept_id=<?php echo $adept_id; ?>"><span class="label label-sm label-warning" title="Re-Schedule"><i class="fa fa-history"></i></span></a></td>
							</tr>
							<?php 	
		$i++;		
		}
