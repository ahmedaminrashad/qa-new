...
$result = mysqli_query($mysql, "SELECT * FROM new_request Where request_id = $er");
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                ...
                                <br><br>Thank you for registering to the Arabic programs at SAIOI. This is a courtesy follow up email to make sure you have received your log in information. If you have not received them, please let us know.
                                <br><br>To help you get started, we are pleased to offer you a trial class with one of our professional native teachers. According to your preferences in the registration form, you shall tell us your available date and time. Please confirm your available date and time in order to proceed with booking your trial class and provide you with the teachers contact info.  Here is our Skype id ( Saioi Support),  Please add us to connect you with the teacher.
If you would like to know your rights and our regulations, please click on the link below:<br>
https://saioi.net/student-policies/
                                <br><br>Jazak Allahu khayran for your interest in Smart Arabic International Online Institute. We ask Allah that he grants us all the ability to understand His Book and to give us sincerity. Amin.
                                <br><br>If you have any questions, please do not hesitate to let us know.<br><br>
                                We look forward to hearing back from you.<br><br>
                                Feel free to ask anything.<br><br>
                                <strong>Best regards</strong>
                                <br><br><br>Mohamed Elseidy<br>
<strong>Admin SAIOI</strong><br>www.saioi.net<br>E-mail:info@saioi.net<br>Skype ID: saioi.1<br>Phone:<br>EGY: +201095538744<br>   
    ...
    if (!$mail->send()) {
        ...
        echo "Message sent to :" . $row['name'] . ' (' . str_replace("@", "&#64;", $row['email']) . ') at '.$time_start.' <a href="list-of-new-request">Go Back</a><br />';
