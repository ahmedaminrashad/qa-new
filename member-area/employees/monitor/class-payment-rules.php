				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-body">
							...
							<p style="margin-left:25px">Below are the rules and regulations to how to deal with the classes at TarteeleQuran.</p>
							...
							<p style="margin-left:25px"><b>3.</b> If the student asks for make-up class for the class with LEAVE status, you should do Re-scheduling by just dropping a message at TarteeleQuran Admin that “Abdul Rahman missed a class on 15-09-2017, please Re-schedule this class on 17-09-2017 at 05:00 PM.” If you Re-scheduled a leave status class and took that class, <span class="font-green"><b>the system will add this class in your WORKING HOURS as you have taken the missed class by a proper Re-scheduling system.</b></span></p>
							<p style="margin-left:25px"><b>4.</b> A situation may come that the student did not come to take the class or declined to take the class at class time and you marked that class as <button type="button" style="width: 75px" class="btn red btn-xs disabled">Absent</button> or <button type="button" style="width: 75px" class="btn red btn-xs disabled">Declined</button>, you are not allowed to give student make-up class but if and only if Admin told you to give that student a make-up class then you should ask TarteeleQuran Admin to add extra class as this is not your liability to give student a make-up class for <button type="button" style="width: 75px" class="btn red btn-xs disabled">Absent</button> or <button type="button" style="width: 75px" class="btn red btn-xs disabled">Declined</button>. Admin will add an extra class and system will pay you extra (double) one for ABSENT or DECLINED class and other for the class you have given by properly adding extra class.</p>
							<p style="margin-left:25px"><b>5.</b>You should schedule any class in ADVANCE. E.g. If there is a class of a student in future and if he requested you to take his/her class today, you should call Admin to schedule his/her class of '06-10-2017' on '05-10-2017' at 06:00 PM.</p>
