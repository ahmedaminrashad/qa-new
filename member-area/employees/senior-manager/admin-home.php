...
if ($check_beta1 < 1) {
    ...
    $check_alpha1 = $check_beta1;
}
if ($check_beta2 > 48) {
    $check_alpha2 = 48;
} else {
    $check_alpha2 = $check_beta2;
}
?>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group has-error">
                                                ...
                                                <datalist id="cars">
                                                    ...
                                                    do { ?>
                                                        <option value="<?php echo $row['teacher_id']; ?>"> <?php echo $row['teacher_name']; ?>
                                                            (<?php echo $row['Nationality']; ?> <?php if ($row['g_id'] == 1) {
                                                                echo 'Male';
                                                            } else {
                                                                echo 'Female';
                                                            } ?>)
                        ...
                        <div class="portlet-body">
                            <h2><?php $old_date_timestamp = strtotime($data_date);
                                ...
                                echo '<span class="label label label-success">' . $new_date . '</span>'; ?> <span
                                        class="label label bg-purple">Admin Home</span></h2>
