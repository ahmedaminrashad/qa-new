						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>You are adding new country
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="define-search-file" method="post" class="form-horizontal form-row-seperated">
				...
				do {  ?>
                      ...
                      <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input required type="date" class="form-control" name="date" id="date">													</div>
												</div>
