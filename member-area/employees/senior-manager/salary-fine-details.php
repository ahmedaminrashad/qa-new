...
<div class="timeline">
						<div class="timeline-item">
							<div class="timeline-body">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM teacher_fine WHERE teacher_id = $famID AND YEAR(date) = $famYear AND MONTH(date) = $famMonth AND type = $famType");
$counter = 0;
if (!$result) 
	{
