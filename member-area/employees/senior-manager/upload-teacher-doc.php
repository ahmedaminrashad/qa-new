...
if (isset($_POST["sub1"]) || isset($_POST["sub2"])) {
  ...
  if (count($_FILES["user_files"]) > 0) {
    ...
    $sql = "INSERT INTO employees_docs(img, teacher_id) VALUES (:img, '$acid')";
    $stmt = $DB->prepare($sql);
...
<div class="page-container">
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="list-of-teachers">Teaching Staff</a><i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Upload Docs <?php echo $cname; ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
						...
						<div class="tab-content">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<div class="form-body">
										<form name="f1" action="upload-teacher-doc?ptec=<?php echo $cid; ?>&cname=<?php echo $cname; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
    ...
    <div>
							<?php 
// sending query
$result = mysql_query("SELECT * FROM employees_docs WHERE teacher_id = $cid ORDER BY doc_id ASC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		...
		if(($i%2)==0) 
			...
			$doc = MYSQL_RESULT($result,$i,"doc_id");
			$tidd = MYSQL_RESULT($result,$i,"teacher_id");
			$imagname = MYSQL_RESULT($result,$i,"img");
?>
