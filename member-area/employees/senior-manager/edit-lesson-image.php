...
if (isset($_POST["sub1"]) || isset($_POST["sub2"])) {
  ...
  if (count($_FILES["user_files"]) > 0) {
    ...
    $sql = "UPDATE lesson_pages SET image_name = :img WHERE lesson_id = '$acid'";
    $stmt = $DB->prepare($sql);
						...
						<div class="tab-content">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<div class="form-body">
										<form name="f1" action="edit-lesson-image?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>&course=<?php echo $course_name; ?>&did=<?php echo $did; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
