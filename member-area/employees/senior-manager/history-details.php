...
?>
			...
			<?php if ($restatus == 1) { echo '<a href="history-delete?history_id='.$hid.'"><button type="button" class="btn red btn-xs">Delete</button></a> <a class="allocation1" href="#allocation-c" data-toggle="modal" data-target="#allocation-c" data-id="'.$hid.'"><button type="button" class="btn blue btn-xs" title="Add Schedule">Re-Schedule</button></a> <a href="leave_absent_mark?history_id='.$hid.'&attend=5"><button type="button" style="width: 75px" class="btn yellow btn-xs">Leave</button></a>'; } ?></b></font>
									</h4>
