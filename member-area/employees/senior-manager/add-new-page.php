	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Add <small>New Page (<?php echo $course_name; ?> - <?php echo $cname; ?>)</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="course-material-lesson?c_id=<?php echo $did; ?>&cname=<?php echo $course_name; ?>"><?php echo $course_name; ?></a><i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 You are adding new page in <?php echo $course_name; ?> - <?php echo $cname; ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Add Page Details <?php echo $msg; ?>
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<div class="form-body">
										<form name="f1" action="add-new-page?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>&course=<?php echo $course_name; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
										<div class="form-body">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Page Name*</strong></label>
															<div class="col-md-4">
