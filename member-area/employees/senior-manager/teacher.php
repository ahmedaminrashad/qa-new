...
if (!$result1) 
	{
    die("Query to show fields from table failed11111");
	}
...
if (!$result2) 
	{
    die("Query to show fields from table failed2222222");
	}
...
If ($tnumberOfRows2 == 0){
 ...
 ?></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND teacher_id = '$tech_id' ORDER BY start_time_A");
if (!$result) 
	{
    die("Query to show fields from table failed333333");
	}
...
?>
				...
				$set_icon= '<i class="fa fa-clock-o"></i>';
								...
								<td><a class="invoicelink" href="#invoice" data-toggle="modal" data-target="#invoice" data-id="<?php echo $sched_id; ?>" data-amu="<?php echo $teacher_id; ?>"><button type="button" class="btn yellow btn-xs">Link</button></a></td>
