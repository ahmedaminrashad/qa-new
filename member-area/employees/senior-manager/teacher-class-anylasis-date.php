...
function class_monitor_num($var2, $var3, $var4){
    $result = mysql_query("SELECT history_id FROM class_history WHERE teacher_id = '$var2' AND monitor_id = '$var3' AND date_teacher = '$var4' AND re_status = 1");
if (!$result) 
	{
    die("Query to show");
	}
...
<a onclick="goBack()" class="btn default">
						...
						<div class="portlet-body">
							<div id="mytable" class="table-responsive">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE teacher_id = '$tech_id' AND date_teacher >= '$date_start' AND date_teacher <= '$date_end' GROUP BY date_teacher;");
   $counter = 0;
if (!$result) 
	{
    die("Query to show");
