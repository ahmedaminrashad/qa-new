...
if (isset($_POST["sub1"]) || isset($_POST["sub2"])) {
  ...
  if (count($_FILES["user_files"]) > 0) {
    ...
    $sql = "INSERT INTO lesson_pages(image_name, lesson_name, lesson_des, dept_id, position_id) VALUES (:img, '$cname', '$desi', '$ddd', '$posi')";
    $stmt = $DB->prepare($sql);
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Add <small>New Lesson (<?php echo $cname; ?>)</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 You are adding new lesson in <?php echo $cname; ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Add Lesson Details <?php echo $msg; ?>
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<div class="form-body">
										<form name="f1" action="add-new-lesson?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
										<div class="form-body">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Lesson Name*</strong></label>
															<div class="col-md-4">
																<input required type="text" placeholder="Lesson No. 01" name="lesson" id="lesson" class="form-control">	
														</div>
													</div>
													<!--/span-->
												<div class="form-group">
												...
												<div class="form-group">
															...
															<div class="col-md-4">
															<textarea required type="text" placeholder="This course is for beginners......some more text..." name="des" id="des" class="form-control"></textarea>														</div>
													</div>
													</div>
													<!--/span-->
														<div class="form-group">
