...
echo $numberOfRows; ?>)</b></a>
						...
						<div class="portlet-body">
							<div id="mytable" class="table-responsive">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM course LEFT JOIN sched ON sched.course_id = course.course_id WHERE course.nature = 1 AND sched.course_id IS NULL");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
								...
								<td>
									 <?php echo abc("$Course_ID"); ?> <a href="parent-accounts-profile?parent_id=<?php echo base64_encode($ppid); ?>"><?php echo $course_yrSec; ?> (<?php echo $Course_ID; ?>)</a>
								</td>
								<td>
