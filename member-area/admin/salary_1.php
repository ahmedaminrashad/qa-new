...
<?php
  ...
  require ("../includes/dbconnection.php");
  include("header.php");
  $tt =base64_decode($_GET["ptec"]);
  $t_name =base64_decode($_GET["name"]);
  $link =$_REQUEST['last_link'];
?>
<?php
...
<div class="page-container">
  ...
  <?php } while ($row = mysql_fetch_assoc($result)); ?>
                ...
                <input type="hidden" id="hidden_dept" name="pti" value="<?PHP echo $tt; ?>"/>
                <input type="hidden" id="hidden_dept" name="pti_name" value="<?PHP echo $t_name; ?>"/>
                <input type="hidden" id="hidden_dept" name="pti_link" value="<?PHP echo $link; ?>"/>
										</form>
...
?>
								...
								<td>
									<a href="salary-details_<?php echo $t_type; ?>?sal_id=<?php echo $sal_id; ?>&teacher_n=<?php echo $t_name; ?>"><button type="button" class="btn green btn-xs">See Details</button></a>
								</td>
							</tr>
							<?php 	
		$i++;		
