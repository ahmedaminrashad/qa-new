...
<div class="timeline">
						<div class="timeline-item">
							<div class="timeline-body">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM account Where MONTH(deactivation_date) = $famID AND YEAR(deactivation_date) = $famName AND dateDiff(deactivation_date,regular_date) > 30");
$counter = 0;
if (!$result) 
	{
