...
header(
			 	"Location: add-student-account?par_id=$g&con_id=$cv&man_id=$mang&trial_id=$trial&time_id=$tz11&time_name=$tzname_tech&time_dif=$tzy_parent&time_php=$tzy_php&cur_id=$cur_id1");
?>