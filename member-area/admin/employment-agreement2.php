...
<li>In case of resign or leaving employment of the Company, in any case, you will have to properly shift all of your classes to the new teacher.</li>
							...
							<ol class="split">
							<li>You are working as full time employee, working at your place.</li>
							<li>Your salary will be calculated on basis of the number of classes per week. The Company will pay the fee if the student has taken at least 25% classes i.e. if a student is taking 4 classes per month, you should take at least one class for the salary of that student.</li>
