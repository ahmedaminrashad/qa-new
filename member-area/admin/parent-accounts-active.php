...
<a href="parent-accounts-active" class="btn blue"><i class="fa fa-user"></i> Active (Active, Fee, Trial, Suspended &amp; On Leave) <b>(No. <?php 
$result = mysql_query("SELECT * FROM account WHERE active = 1 OR active = 5 OR active = 17 OR active = 7 OR active = 11");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
<a href="parent-accounts-left" class="btn red"><i class="fa fa-user-times"></i> Deactivated <b>(No. <?php echo NUM("3"); ?>)</b></a>
						...
						<div class="tabbable tabbable-custom tabbable-custom-profile">
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id HAVING active = 1 ORDER BY parent_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id HAVING active = 5 ORDER BY parent_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id HAVING active = 11 ORDER BY parent_id ASC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	...
	while($row = mysql_fetch_array($result))
		{		
			...
			$timezdif = MYSQL_RESULT($result,$i,"timezone_diff");
			$phptime = MYSQL_RESULT($result,$i,"php_tz");
			$t_d = MYSQL_RESULT($result,$i,"trial_date");
...
?>
							...
							<table class="table table-hover">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id HAVING active = 17 ORDER BY parent_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	...
	while($row = mysql_fetch_array($result))
		{		
			...
			$timezdif = MYSQL_RESULT($result,$i,"timezone_diff");
			$phptime = MYSQL_RESULT($result,$i,"php_tz");
			$country = MYSQL_RESULT($result,$i,"c_name");
			$t_d = MYSQL_RESULT($result,$i,"suspension_date");
