...
mysql_query ("UPDATE profile SET salary_amount = '$salary_amu', currency = '$rent_amu', tax = '$tax_amu', bank = '$teacher_bank', branch_code = '$teacher_bcode', account_no = '$teacher_acc', account_title = '$teacher_title', hour_rate = '$teacher_hour', medical = '$tmedi', entertainment = '$tent', misc = '$tmisc', eobi = '$teobi', link = '$zoom', group_id = '$wa' WHERE teacher_id = '$pppiiiddd'") or die(mysql_error()); 
