                                                    ...
                                                    <table width="100%" align="center" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"
                                                                ...
                                                                <br><br>Thank you for registering to the Arabic programs
                                                                at '.$site_nameC.'. This is a courtesy follow up email
                                                                to make sure you have received your log in information.
                                                                If you have not received them, please let us know.
                                                                <br><br>To help you get started, we are pleased to offer
                                                                you a trial class with one of our professional native
                                                                teachers. According to your preferences in the
                                                                registration form, you shall tell us your available date
                                                                and time. Please confirm your available date and time in
                                                                order to proceed with booking your trial class and
                                                                provide you with the teachers contact info. Here is our
                                                                Skype id ('.$skype_zoom.'), Please add us to connect you
                                                                with the teacher.
                                                                <br><br>Jazak Allahu khayran for your interest in
                                                                '.$site_nameC.'. We ask Allah that he grants us all the
                                                                ability to understand His Book and to give us sincerity.
                                                                Amin.
                                                                <br><br>If you have any questions, please do not
