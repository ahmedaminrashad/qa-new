                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;"><br><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="item_name_1" value="'.$row['parent_name'].' for '.$m.'-'.$y.'-Email" />
<input type="hidden" name="amount_1" value="'.$fee.'" />
<input type="hidden" name="quantity_1" value="1" />
<input type="hidden" name="item_number" value="" />
<input type="hidden" name="shipping_1" value="0.00" />
<input type="image" style="height: 6vh;" src="https://quransquare.com/resources/newassets/images/paypal_btn.png"
     name="submit" class="wp_cart_checkout_button"
     alt="Make payments with PayPal - it\'s fast, free and secure!" />
<input type="hidden" name="return" value="https://'.$site_nameS.'/member-area/accounts/payment-done.php" />
<input type="hidden" name="business" value="'.$paypal_email.'" />
<input type="hidden" name="currency_code" value="'.$account.'" />
<!-- Custom variable here: -->
<input type="hidden" name="custom" value="'.$in_id.'">
