								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<div class="form-group">
												...
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Earning Via Classes</strong> (<?php echo class_earning("2", "$tid"); ?> X <?php echo $tcrate; ?>)</label>
													<div class="col-md-4">
														<input type="text" value="<?php echo class_earning("1", "$tid"); ?>" name="class_salary" id="class_salary" class="form-control input-circle" readonly>
													</div>
												</div>
												<div class="form-group">
												...
												<input type="hidden" value="<?php echo $_REQUEST['type_cat']; ?>" name="cat_id" id="cat_id" class="form-control input-circle">
												...
												<input type="hidden" value="<?php echo class_earning("2", "$tid"); ?>" name="total_classes" id="total_classes" class="form-control input-circle">
												<input type="hidden" value="<?php echo csr_earning("2", "$tid"); ?>" name="total_students" id="total_students" class="form-control input-circle">
												<input type="hidden" value="0" name="total_hours" id="total_hours" class="form-control input-circle">
