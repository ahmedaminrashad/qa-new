...
include("../includes/session1.php");
  include("header.php");
$pp_id =$_REQUEST["parent_id"];
$ppname =$_REQUEST["name"];
$ppnote =$_REQUEST["note"];
    if (isset($_POST['cmdSubmit'])) 
  	{ 		
			...
			mysql_query ("INSERT INTO task_creator (from_person, to_person, date, status, des, parent_id, parent_name)
					VALUES('$from_me', '$to_you', '$create_date', '$task_status', '" . mysql_real_escape_string($_POST['comment']) . "', '$pid', '$pname')") or die(mysql_error()); 
					 header(
									...
									<div class="portlet-body form">
										...
										<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal form-row-seperated">
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<textarea class="form-control input-circle" placeholder="Enter Your Comments" name="comment" id="comment"><?php echo $ppnote; ?></textarea>
													</div>
												</div>
												<input type="hidden" value="<?php echo $sy; ?>" name="date" id="date" class="form-control input-circle"></input>
												<input type="hidden" value="<?php echo $pp_id; ?>" name="parent_id" id="parent_id" class="form-control input-circle"></input>
												<input type="hidden" value="<?php echo $ppname; ?>" name="parent_name" id="parent_name" class="form-control input-circle"></input>
