	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Parent Accounts<small> On Trial</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 List of Parent Accounts On Trial
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h4>List of Parent Accounts On Trial <?php echo $sy; ?></h4>
						<div class="portlet light">
...
<br><br>
<a href="parent-accounts-active" class="btn btn-xs green"><i class="fa fa-clock-o"></i> Paid <b>(No. <?php echo NUM("1"); ?>)</b></a>
<a href="parent-accounts-free" class="btn btn-xs purple"><i class="fa fa-clock-o"></i> Fee <b>(No. <?php echo NUM("5"); ?>)</b></a>
<a href="parent-accounts-on-trial" class="btn btn-xs yellow"><i class="fa fa-clock-o"></i> Trial <b>(No. <?php echo NUM("11"); ?>)</b></a>
<a href="parent-accounts-on-leave" class="btn btn-xs blue"><i class="fa fa-clock-o"></i> Leave <b>(No. <?php echo NUM("7"); ?>)</b></a>
<a href="parent-accounts-on-suspension" class="btn btn-xs red"><i class="fa fa-clock-o"></i> Suspended <b>(No. <?php echo NUM("17"); ?>)</b></a>
