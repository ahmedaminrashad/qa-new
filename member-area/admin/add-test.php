...
<?php
    ...
    if (isset($_POST['cmdSubmit'])) 
  	{ 		
			...
			$apn= $_POST['tzphp'];	
			$sst= $_POST['stut'];	
			mysql_query ("INSERT INTO test_results (course_id, teacher_id, m_id, y_id, test_date, test_time, test_discription, parent_id, dept_id, c_id, g_id, lan_id, tremark, time_name, phptime, man_id, test_status)
					VALUES('$as_id', '$at_id', '$am_id', '$ay_id', '$adat', '$atim', '" . mysql_real_escape_string($adis) . "', '$app_id', '$ad_id', '$ac_id', '$ag_id', '$al_id', '$apr_id', '$atn', '$apn', '$aman_id', '$sst')") or die(mysql_error()); 
					 header(
