							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li>
											<a href="leave-status">
											<span class="badge badge-success"> <?php echo LeaveApproved("2"); ?> </span> PENDING </a>
										</li>
										<li>
										...
										<li class="active">
											...
											<span class="badge badge-success badge-active"> <?php echo LeaveApproved("6"); ?> </span> NOT-APPROVED </a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-helper">Not Approved:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase"> APPLICATIONS (<?php echo LeaveApproved("6"); ?>)</span>
								</div>
							</div>
							<!-- end PROJECT HEAD -->
								...
								<div class="row">
									<div class="">
										<div class="scroller" style="max-height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											...
											<?php 
// sending query
$result = mysql_query("SELECT * FROM leave_app WHERE status = 6 ORDER BY leave_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	{
	echo '<div class="label label-info">No Approved leave Application Found!</div>';
	}
...
?>
													...
													<span class="label label-sm label-info">Rejected, no action required</span> <a href="update-leave?status=1&leave=<?php echo $leaveid; ?>"><button type="button" class="btn green btn-xs">Validate Again</button>
														</div>
												</div>
												<?php 	
		$i++;		
