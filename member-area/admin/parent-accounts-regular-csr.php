		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h4>Ragular by: <b><?php echo ''.$csr_name.' ('.$mm_id.'-'.$yy_id.')'; ?></b></h4>
...
echo $numberOfRows; ?>)</b></a>
						...
						<div class="portlet-body">
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id HAVING MONTH(regular_date) = $mm_id AND YEAR(regular_date) = $yy_id AND csr_id = $csr_id ORDER BY parent_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
