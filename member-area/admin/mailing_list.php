                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
								...
								<a href="https://www.'.$site_nameS.'/member-area/accounts/">www.'.$site_nameS.'/member-area/accounts</a><br>User Name: '.$row['username'].'<br>User Pass: '.$row['userpass'].'<br><br>
...
<br>You will have the option to pay in the currency of your choice during checkout.<br>If the payment link does not work properly, please contact <strong>'.$email2.'</strong><br>
