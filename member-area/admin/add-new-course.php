						...
						<div class="tab-content">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<div class="form-body">
										<form name="f1" action="add-new-course" method="post" enctype="multipart/form-data" class="form-horizontal">
										<div class="row">
													<div class="col-md-6">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
															<input required type="number" placeholder="1" name="age" id="age" class="form-control">														</div>
													</div>
													</div>
													<!--/span-->
												</div>
