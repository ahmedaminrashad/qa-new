...
$result = mysqli_query($mysql, "SELECT * FROM class_history WHERE date_admin = '$date' AND start_time_A <= '$time_start' AND end_time_A >= '$time_start' AND monitor_id = '1' AND re_status != 2 AND whatsapp = '1'");
...
$group = MYSQL_RESULT($result2,$i,"group_id");
mysql_query("UPDATE class_history SET whatsapp = '2' WHERE history_id = '$Hid1'") or die(mysql_error());
