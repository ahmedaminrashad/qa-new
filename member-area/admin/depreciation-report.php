	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Depreciation <small>Report</small></h1>
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 Depreciation Report for the period <b><?php $date1=date_create($p_sy); 
				...
				<div class="col-md-12">
					...
					<h4></h4>
							<div id="mytable" class="table-responsive">
								...
								<?php 
// sending query
$result = mysql_query("SELECT `account_entry`.*, `accounts_head`.`account_head_name`, `vendor`.`vendor_name` FROM `account_entry`,`accounts_head`, `vendor` WHERE account_entry.account_head=accounts_head.account_head_id and account_entry.vendor_id=vendor.vendor_id GROUP BY account_head HAVING ac_cat_id = 10 ORDER BY date DESC;");
	if (!$result) 
	{
