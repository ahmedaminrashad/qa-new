                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;"><br>
                            
                                      <a href="https://www.2checkout.com/checkout/purchase?currency_code='.$account.'&sid='.$CO_number.'&total='.$fee.'&cart_order_id='.$row['parent_name'].' for '.$m.'-'.$y.'-Email&c_prod=5&id_type=2&lang=en&mode=new&fixed=Y&py_id='.$in_id.'">
