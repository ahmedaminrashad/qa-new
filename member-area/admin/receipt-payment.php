					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM account_entry WHERE (ac_cat_id = 3 OR ac_cat_id = 4 OR ac_cat_id = 6) AND MONTH(date) = $month AND YEAR(date) = $year GROUP BY account_head");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM account_entry WHERE (ac_cat_id = 2 OR ac_cat_id = 7 OR ac_cat_id = 8 OR ac_cat_id = 9 OR ac_cat_id = 1 OR ac_cat_id = 10 OR ac_cat_id = 11) AND MONTH(date) = $month AND YEAR(date) = $year GROUP BY account_head");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
$('.notes').click(function(){
    ...
    $.ajax({url:"entry-details.php?famID="+famID+"&famValue="+famValue+"&famMonth="+famMonth+"&famYear="+famYear,cache:false,success:function(result){
