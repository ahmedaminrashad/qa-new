					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Receipts for Year <?php echo $year; ?></span>
							</div>
							<div class="tools">
...
<div id="full-width" class="modal container fade" tabindex="-1">
								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="receipt-payment-year-search" method="GET" class="form-horizontal">
											<div class="form-body">
												<h3 class="form-section">Please Select Desired Year</h3>
												<div class="row">
													<!--/span-->
													<div class="col-md-6">
