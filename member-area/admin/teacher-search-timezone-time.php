	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Search Teacher<small> on timezone</small></h1>			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 You are Searching Schedule at Student's Timezone
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Search Schedule at Student's Timezone
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="teacher-search-timezone-results" method="post" class="form-horizontal form-row-seperated">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Student Timezone</strong></label>
															<div class="col-md-9">
															<select class="form-control" name="timez"  id="timez" onchange="javascript: return optionList9_SelectedIndex()">
                    <?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
				$result = mysql_query("SELECT * FROM time_zone ORDER BY tz_id");			  	
				do {  ?>
                    <option value="<?php echo $row['tz_id'];?>"><?php echo $row['timezone_name'];?> (<?php echo $row['timezone'];?>:00) </option>
