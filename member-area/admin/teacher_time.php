...
If ($tnumberOfRows2 == 0){
 ...
 ?></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND teacher_id = '$tech_id' and start_time_A <= '$time_id' and end_time_A > '$time_id' ORDER BY start_time_A");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
