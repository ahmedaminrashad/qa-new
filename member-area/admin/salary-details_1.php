	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 Salary Detail of <?php echo $tname; ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- BEGIN PAGE CONTENT INNER -->
				...
				<div class="portlet light">
								...
								<td> <b>Rs. <?php echo $t_salary; ?></b></td>
								</tr>
								<tr>
								<td class="auto-style2">Total Additions:</td>
								<td>
								<b><span class="auto-style1">Rs. <?php echo $total_add; ?></span></b>
								</td>
								</tr>
								<tr>
								...
								<td><a class="fine" href="#fine-d" data-toggle="modal" data-target="#fine-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-type="4" data-name="Compony Returns">Rs. <?php echo $t_returns; ?></a></td>
								</tr>
								<tr>
								<td>Performance Bonus:</td>
								<td><a class="fine" href="#fine-d" data-toggle="modal" data-target="#fine-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-type="2" data-name="Bonus">Rs. <?php echo $t_bouns; ?></a></td>
								</tr>
								<tr>
								...
								<td>
								<a class="fine" href="#fine-d" data-toggle="modal" data-target="#fine-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-type="5" data-name="Fine Reduction">Rs. <?php echo $t_reduc; ?></a>
								</td>
								</tr>
								<tr>
								...
								<td>Fines:</td>
								<td>
								<a class="fine" href="#fine-d" data-toggle="modal" data-target="#fine-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-type="1" data-name="Fines">Rs. <?php echo $t_fine; ?></a>
								</td>
								</tr>
								<tr>
								<td>Leave Deduction:</td>
								<td>
								<a class="leaves" href="#leaves-d" data-toggle="modal" data-target="#leaves-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-amu="<?php echo $t_salary; ?>">Rs. <?php echo $t_leave; ?></a>
								</td>
								</tr>
								<tr>
								<td>Advance Deduction:</td>
								<td>
								<a class="fine" href="#fine-d" data-toggle="modal" data-target="#fine-d" data-id="<?php echo $ttt_id; ?>" data-month="<?php echo $smonth; ?>" data-year="<?php echo $syear; ?>" data-type="3" data-name="Advances">Rs. <?php echo $t_advance; ?></a>
								</td>
								</tr>
								<tr>
								<td>Tax:</td>
