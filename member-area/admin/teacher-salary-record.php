...
?>
								...
								<td>
									 <b><a href="salary-details?sal_id=<?php echo $sal_id; ?>&month=<?php echo date('F-Y',strtotime($t_date)); ?>&teach_id=<?php echo $ttt_id; ?>"><?php echo date('F-Y',strtotime($t_date)); ?></a></b>
								</td>
