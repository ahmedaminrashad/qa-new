...
$result = mysql_query ("SELECT * FROM sched3")or die(mysql_error());
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
	...
	while ($i<$numberOfRows)
		{			
			...
			if ((( $teacher == $teacher_name or $course == $student_name) && (($day == $tday1 or $day == $tday2 or $day == $tday3 or $day == $tday4 or $day == $tday5 or $day == $tday6 or $day == $tday7) and  $stime == $teacher_time))){
			   $result = mysql_query("SELECT `sched3`.*, `day`.`day_name`, `course`.`course_yrSec`, `room`.`room_name`,
	...
	<div class="page-content">
		<div class="container">
			...
			<div class="row">
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<input type="hidden" value="<?php echo $s_id; ?>" class="form-control" name="pstudent" id="pstudent">
										<input type="hidden" value="<?php echo $go2; ?>" class="form-control" name="goo" id="goo">
				...
				$result = mysql_query("SELECT * FROM profile WHERE (cat_id = 8 or teacher_rights = 1) and active = 1 and inout_id = 1 and training = 1 ORDER BY teacher_id ");			  	
				do {  ?>
				...
				do {  ?>
                    ...
                    <?php } while ($row = mysql_fetch_assoc($result)); ?>
										...
										<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Class Status</strong></label>
															<div class="col-md-9">
