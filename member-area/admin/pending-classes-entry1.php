...
mysql_query("UPDATE sched3 SET date = '$today', date2 = '$today2', adayid = '$c', amonid = '$am', ayearid = '$ay', sdayid = '$sc', smonid = '$sm', syearid = '$sy' , make = '2' WHERE php_tz = '$to' AND aday_id = '$c' AND mnt_id = '5'") or die(mysql_error());
}
}
if ($result){
mysql_query("INSERT INTO History2(course_id, teacher_id, student_date, student_day, student_month, student_year, admin_date, admin_day, admin_month, admin_year, sched_id, a_id, dept_id, additional_dept, make)
	SELECT course_id, teacher_id, date2, sdayid, smonid, syearid, date, adayid, amonid, ayearid, uni, mnt_id, dept_id, adept_id, make
	FROM sched3 WHERE aday_id = '$c' AND mnt_id = '5'") or die(mysql_error());
	if(mysql_query){
mysql_query ("UPDATE History2 SET lesson_id = '100', lesson_discription = 'N-A', teacher_remarks = '6', a_id = '9' WHERE admin_date = '$today' AND make = '2'") or die(mysql_error());
}
}
?>