...
?>
								...
								<td>
									 <b><a href="teacher-performance-anylasis?csr=<?php echo $profile_no; ?>&name=<?php echo $tname; ?>&month=<?php echo $mm_id; ?>&year=<?php echo $yy_id; ?>"><?php echo $tname; ?> (<?php echo $profile_no; ?>)</a> <?php if ($witness_id1 == 1 OR $witness_id2 == 1 OR $cheque_id == 1 Or $agree_id == 1) {echo '<i class="fa fa-warning font-yellow"></i>';} else {echo '';} ?></b>
								</td>
								<td>
									<?php echo perform("$profile_no","$mm_id","$yy_id"); ?>
								</td>
								<td>
									 <?php echo $gender; ?>
								</td>
