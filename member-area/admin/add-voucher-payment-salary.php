  ...
  include("header.php");
    if (isset($_POST['cmdSubmit'])) 
  	{ 		
		 	...
		 	$vbank= $_POST['bank_id'];
			mysql_query ("INSERT INTO voucher (voucher_num, cheque_num, date, type_id, bank_id, status)
					VALUES('$vun','$chn','$vdate','2','$vbank','2')") or die(mysql_error()); 
					 header(
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Add <small>New Voucher</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
						...
						<div class="tab-content">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>You are adding new SALARY voucher
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal form-row-seperated">
										<input type="hidden" class="form-control" name="vou_type"  id="vou_type" value="1">
										<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Voucher Number</strong></label>
															<div class="col-md-4">
															<input required type="text" value="IT/Admin/<?php echo $month; ?>/<?php echo $year; ?>/" name="vou_n" id="vou_n" class="form-control">															</div>
												</div>
												<div class="form-group">
															<label class="control-label col-md-3">
