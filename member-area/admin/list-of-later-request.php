...
echo $numberOfRows; ?>)</b></a></h4>
						...
						<?php 
// sending query
$result = mysql_query("SELECT * FROM new_request WHERE status = 10 ORDER BY request_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{		
			...
			$stu_id = MYSQL_RESULT($result,$i,"status");
?>
							...
							<div class="timeline-body">
								...
								<div class="timeline-body-head">
									<div class="timeline-body-head-caption">
										...
										<span class="timeline-body-time font-grey-cascade"><?php echo $adate; ?> (<?php echo $atime; ?>)</span> <?php if ($stu_id == 2){ echo '<span class="label label-sm label-danger" title="Status">Removed</span>'; } elseif($stu_id == 4) {echo'<span class="label label-sm label-success" title="Status">Scheduled</span>';} ?>
									</div>
