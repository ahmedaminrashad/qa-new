...
?>
														...
														<tr>
															...
															<td><a href="mail-direct-link?y=<?php echo time(); ?>&invoice_no=<?php echo $pidy; ?>&account=<?php echo abv("$cuanid"); ?>&month=<?php echo $mon; ?>&year=<?php echo $ayear; ?>&cur=<?php echo $cuan; ?>&amount=<?php echo $fe+$fe_add; ?>&parent=<?php echo $prid; ?>&link=<?php echo $link; ?>"><button type="button" title="Email Direct Payment Link" class="btn yellow btn-xs"><i class="fa fa-envelope"></i></button></a></td>
															<td><a href="mail-direct-link-recurring?y=<?php echo time(); ?>&invoice_no=<?php echo $pidy; ?>&account=<?php echo abv("$cuanid"); ?>&month=<?php echo $mon; ?>&year=<?php echo $ayear; ?>&cur=<?php echo $cuan; ?>&amount=<?php echo $fe+$fe_add; ?>&parent=<?php echo $prid; ?>&link=<?php echo $link; ?>"><button type="button" title="Email Recurring Payment Link" class="btn green btn-xs"><i class="fa fa-envelope"></i></button></a></td>
															<td><a href="mail-direct-link-paypal?y=<?php echo time(); ?>&invoice_no=<?php echo $pidy; ?>&account=<?php echo abv("$cuanid"); ?>&month=<?php echo $mon; ?>&year=<?php echo $ayear; ?>&cur=<?php echo $cuan; ?>&amount=<?php echo $fe+$fe_add; ?>&parent=<?php echo $prid; ?>&link=<?php echo $link; ?>"><button type="button" title="Email Direct Payment Link PayPal" class="btn yellow btn-xs"><i class="fa fa-paypal"></i></button></a></td>
														</tr>
														<?php
														$i++;		
		}
