...
echo $numberOfRows; ?>)</b></a>
						...
						<div class="portlet-body">
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT * from account where (active = 1 OR active = 11) and parent_id not in (select parent_id from invoice where mon_id = 2 and y_id = 5)") or die(mysql_error());
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
