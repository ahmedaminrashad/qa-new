...
If ($numberOfRows == 0) 
	...
	while($row = mysql_fetch_array($result))
		{		
			...
			$em_no = MYSQL_RESULT($result,$i,"cat_id");
?>
							</tr>
								</thead>
								<tbody>
								...
								<td>
									 <b><input class="aCheckbox" name="name[]" type="checkbox" value="<?php echo $tname; ?>" checked><a href="teacher-schedule?pT=<?php echo $profile_no; ?>"><?php echo $tname; ?> (<?php echo $profile_no; ?>)</a> <?php if ($witness_id1 == 1 OR $witness_id2 == 1 OR $cheque_id == 1 Or $agree_id == 1) {echo '<i class="fa fa-warning font-yellow"></i>';} else {echo '';} ?></b>
								</td>
								<td>
								...
								<td><input class="aCheckbox" name="amu[]" type="checkbox" value="<?php echo salary1("$profile_no", "$mm_id", "$yy_id"); ?>" checked><?php echo salary1("$profile_no", "$mm_id", "$yy_id"); ?></td>
								
								<td>
									 <input class="aCheckbox" name="tax[]" type="checkbox" value="<?php echo tax("$profile_no", "$mm_id", "$yy_id"); ?>" checked><?php echo tax("$profile_no", "$mm_id", "$yy_id"); ?>
								</td>
								<td>
									 <?php echo $b_name; ?><input name="acc_cat[]" type="checkbox" value="<?php if ($em_no == 8 OR $em_no == 7) { echo 7; } else { echo 8; }?>" class="aCheckbox" checked>
								</td>
								<td>
									 <?php echo $b_code; ?><input class="aCheckbox" name="acc_head[]" type="checkbox" value="<?php if ($em_no == 8 OR $em_no == 7) { echo 2; } else { echo 8; }?>" checked>
								</td>
								<td>
									 <?php echo $b_no; ?>
								</td>
...
?>
								...
								<div class="form-group">
															<div class="col-md-4">
																<select required class="form-control" name="voucher"  id="voucher" onchange="javascript: return optionList9_SelectedIndex()">
