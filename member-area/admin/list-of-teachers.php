...
?>
								...
								<td>
									 <a href="teacher-class-anylasis?profile_no=<?php echo base64_encode($profile_no); ?>"><?php echo $gender; ?></a>
								</td>
								<td>
								...
								<td>
									<?php if ($rg_training == 2){ echo '<font color="FE2E2E"><b>On Training</b></font>'; } else {echo 'Active';} ?>
								</td>
