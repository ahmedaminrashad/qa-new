		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h4><?php if ($csr_status == 7){ echo 'List of Active requests of'; } elseif ($csr_status == 6){ echo 'List of Removed requests of'; } echo $csr_name; ?></h4>
						<div class="portlet-body">
							<div class="timeline">
						<!-- TIMELINE ITEM -->
						<?php 
// sending query
$result = mysql_query("SELECT * FROM new_request WHERE status = $csr_status AND csr_id = $csr_id ORDER BY request_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
