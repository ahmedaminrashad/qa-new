...
?>
													...
													<div class="todo-tasklist-controls pull-right">
														<a href="clear-task?pT=<?php echo base64_encode($taskid); ?>&link=<?php echo $link; ?>"><button type="button" class="btn green btn-xs">Clear Now</button></a> <a href="delete-task?pT=<?php echo $taskid; ?>"><button type="button" class="btn red btn-xs">Delete</button></a>
														</div>
												</div>
												<?php 	
		$i++;		
