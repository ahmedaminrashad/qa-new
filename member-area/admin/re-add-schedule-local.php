...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{			
			...
			$teacherid= $_POST['pteacher'];
			if ((( $teacher == $teacherid or $course == $student_name) && (($day == $tday1 or $day == $tday2 or $day == $tday3 or $day == $tday4 or $day == $tday5 or $day == $tday6 or $day == $tday7) and  $stime == $teacher_time))){
				...
				do {  ?>
                      ...
                      <?php } while ($row = mysql_fetch_assoc($result)); ?>
											...
											<div class="form-group">
															...
															<div class="col-md-9">
															<select required class="form-control" name="pstudent"  id="pstudent" onchange="javascript: return optionList43_SelectedIndex()">
                      <?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
				$result = mysql_query("SELECT * FROM course WHERE course_id = $cou_id");			  	
				do {  ?>
...
<script language="javascript" >
	...
	form.pstudent.value = ("<?php echo $cou_id; ?>");
