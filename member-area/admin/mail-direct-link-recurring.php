                                        ...
                                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    <a href="https://www.quranoasis.com/">QuranOasis.Com</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="center" valign="top">
                                                    <table width="100%" align="center" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <table width="100%" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" align="center" valign="top"
                                                                            style="padding: 0 10px 0 0;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">
                                                                            <br>
                                                                            <font color="blue">Kindly pay your invoice
                                                                                just by clicking on button below to
                                                                                process a recurring invoice. We have
                                                                                made it easy for you.</font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2" align="center" valign="top"
                                                                          ...
                                                                          <br>
                                                                        	...
                                                                        	<a href="https://www.2checkout.com/2co/buyer/purchase?currency_code='.$account.'&sid='.$CO_number.'&mode=2CO&li_1_price='.$fee.'&li_1_name=Recurring payment&li_1_type=product&li_1_recurrence=1 Month&li_1_duration=Forever&merchant_order_id='.$prid1.'&py_id='.$in_id.'">
                                                                                <input type="image"  style="height: 6vh;" src="https://qarabic.com/resources/newassets/images/checkout_btn.png"
                                                                            </a>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"
                                                                style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">
                                                                Kindly Pay your invoice before/on due date. If you are
                                                                unable to pay your invoice due to any reason, please
                                                                inform us telling the date you will pay your invoice at
                                                                <strong>'.$email2.'</strong> so that your classes remain
                                                                ...
                                                                <br><br><br>'.$name.'<br>
                                                                <strong>Accounts
                                                                    '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email2.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
