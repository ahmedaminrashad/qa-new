				...
				<!-- BEGIN NOTIFICATION DROPDOWN -->
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong><?php echo newrequest(); ?> 
								New Requests</strong>awaiting.</h3>
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong><?php echo trial2(); ?> 
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong><?php echo note2(); ?> </strong>
								unread comments</h3>
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong><?php echo leave2(); ?> 
					...
					<li class="dropdown dropdown-extended dropdown-dark dropdown-inbox" id="header_inbox_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								<h3>You have <strong><?php echo task() ?> New</strong> 
								Tasks</h3>
