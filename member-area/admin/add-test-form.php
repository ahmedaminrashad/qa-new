								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<div class="md-checkbox col-md-5">
											...
											<span class="check"></span>
											<span class="box"></span>
											Have no idea about Qulqala. </label>
										</div>													
											</div>
												</div>';} ?>
												<?php if ($guuna == 1){
									...
									<div class="md-checkbox-inline col-md-9">
										...
										<?php if ($cdept >= 2){
										echo '<input type="hidden" value="1" name="reading" id="reading"><div class="form-group">
															<label class="control-label col-md-3">
										...
										<div class="form-group">
											...
											<?php if ($cdept >= 3){
										echo '<input type="hidden" value="1" name="hifz" id="hifz"><div class="form-group">
															<label class="control-label col-md-3">
