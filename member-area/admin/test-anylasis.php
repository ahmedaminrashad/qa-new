...
[{
    ...
    "request": <?php echo students("$last_date6"); ?> ,
    ...
    "students": <?php echo trash("$last_date5"); ?> ,
    ...
    "students": <?php echo trash("$last_date4"); ?> ,
    ...
    "students": <?php echo trash("$last_date3"); ?> ,
    ...
    "students": <?php echo trash("$last_date2"); ?> ,
    ...
    "students": <?php echo trash("$last_date1"); ?> ,
