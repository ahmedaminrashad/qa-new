...
$userpass = MYSQL_RESULT($result, $i, "userpass");
}
    
}else{
    
$result = mysql_query("SELECT * FROM profile Where Email = '$email' ");
if (!$result) {
    die("Query to show fields from table failed");
}else{
$parent_name = MYSQL_RESULT($result, $i, "teacher_name");
$username = MYSQL_RESULT($result, $i, "username");
$userpass = MYSQL_RESULT($result, $i, "userpass");
}
...
$email = 'deve.ahmedramadan@gmail.com';
$parent_name = $parent_name;// 'ahmed ramadan';
...
$mail->Subject = "Forgot Password ".$site_nameS;//$subject_sched;
...
<body id="body-layout" style="background: #ffffff;">
                                        ...
                                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    Assalamualaikum '.$parent_name.'</td>
                                            </tr>
                                            <tr>
                                                <td height="30" style="height: 30px; line-height:30px;"></td>
                                            </tr>
  ...
  //  header("Location: https://quransquare.com/RegisterDone.html");
   ...
   // header("Location: https://quransquare.com/RegisterDone.html");
       echo "Message sent to :" . $parent_name . ' (' . str_replace("@", "&#64;", $email) . ') at '.$time_start.' <a href="list-of-new-request">Go Back</a><br />';
