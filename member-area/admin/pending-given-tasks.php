								...
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li class="active">
											...
											<span class="badge badge-success badge-active"> <?php echo pending("1","1","1"); ?> </span> ACTIVE </a>
										</li>
										<li>
										...
										<li>
											...
											<span class="badge badge-success"> <?php echo pending("1","1","2"); ?> </span> AWAITING </a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="row">
									<div class="">
										<div class="scroller" style="max-height: 800px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											...
											<?php 
// sending query
$result = mysql_query("SELECT * FROM task_creator WHERE clear = '1' AND to_person = '1' AND status = '1' ORDER BY task_id DESC;");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
