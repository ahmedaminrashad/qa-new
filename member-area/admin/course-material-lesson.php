									...
									<div class="col-md-6">
										<div class="booking-result">
											...
											<div class="booking-info">
												<h2>
												<a href="lesson-page?c_id=<?php echo $lid; ?>&did=<?php echo $cid; ?>">
											<?php echo $lname; ?> </a>
												</h2>
												...
												<p>
													 <a href="edit-lesson-image?c_id=<?php echo $lid; ?>&cname=<?php echo $lname; ?>&course=<?php echo $cname; ?>&did=<?php echo $cid; ?>"><button type="button" class="btn blue btn-xs"><i class="fa fa-file-image-o"></i></button></a> 
														<a href="edit-lesson?c_id=<?php echo $lid; ?>&cname=<?php echo $lname; ?>&course=<?php echo $cname; ?>&did=<?php echo $cid; ?>"><button type="button" class="btn yellow btn-xs"><i class="fa fa-edit"></i></button></a>
														<a href="add-new-page?c_id=<?php echo $lid; ?>&cname=<?php echo $lname; ?>&course=<?php echo $cname; ?>&did=<?php echo $cid; ?>"><button type="button" class="btn green btn-xs"><i class="fa fa-plus"></i></button></a>
												</p>
											</div>
										</div>
									</div>
