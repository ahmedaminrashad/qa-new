						...
						<div class="timeline-item">
							<div class="timeline-body">
								...
								<div class="timeline-body-content">
									...
									<h4>Leaves From: <?php echo $famMonth; ?> To: <?php echo $famYear; ?></h4>
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM teacher_attendance WHERE teacher_id = $famID AND date >= '$famMonth' AND date <= '$famYear' AND status = 2");
$counter = 0;
if (!$result) 
	{
...
If ($numberOfRows == 0) 
	{
	echo '<b class="green">No Leave Found between ('.$famMonth.')-('.$famYear.')</b>';
	}
