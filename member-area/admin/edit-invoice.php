...
$link =base64_decode($_GET["link"]);
	...
	if (!$result) 
		...
		die("Query to show fields from table failed");
			...
			$invoive_add = MYSQL_RESULT($result,$i,"invoice_add");
			$invoive_num = MYSQL_RESULT($result,$i,"order_num");
...
$aadj= $_POST['adj'];
$aord= $_POST['ord'];
			mysql_query( "UPDATE invoice SET due = '$adue', fee = '$afee', status = '$astu', invoice_add = '$aadj', order_num = '$aord' WHERE py_id = '$anid'") or die(mysql_error()); 
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															Due Date</label>
															<div class="col-md-9">
																<input type="date" class="form-control" value="<?php echo $invoive_due; ?>" name="dued" id="dued">
															</div>
														</div>
													</div>
													<!--/span-->
