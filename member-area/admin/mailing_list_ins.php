                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding: 0 20px;">
                                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 22px; font-weight: 400;color: #302f35;">
                                                    This is a request for payment from:
                                                ...
                                                <td align="center" valign="top">
                                                    <table width="100%" align="center" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <table width="100%" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" valign="top"
                                                                            style="padding: 0 10px 0 0;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">
                                                                            Billing Details:</td>
                                                                        <td align="left" valign="top"
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"
                                                                style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">
                                                                Kindly use the following credentials to login your
                                                                account for payments.<br><br>Login Link:
                                                                <a
                                                                    href="https://www.'.$site_nameS.'/member-area/accounts/">www.'.$site_nameS.'/member-area/accounts</a><br>User
                                                                Name: '.$row['username'].'<br>User Pass:
                                                                '.$row['userpass'].'<br><br>
                                                                Once you logged in, you will find your invoice under the
                                                                "Invoice(s)". Kindly follow the "Pay Now" link to fill
                                                                your order to checkout.<br>Your secure order will be
                                                                processed by 2Checkout.net, Inc.
                                                                <br>You will have the option to pay in the currency of
                                                                your choice during checkout.<br>If the payment link does
                                                                not work properly, please contact
                                                                <strong>'.$email1.'</strong><br>
                                                                <br>Kindly Pay your invoice before/on due date. If you
                                                                are unable to pay your invoice due to any reason, please
                                                                inform us telling the date you will pay your invoice at
                                                                <strong>'.$email1.'</strong> so that your classes remain
                                                                continue without any inconvenience.<br>
                                                                We sincerely thank you for choosing us to be your online
                                                                Quran Learning Institute.<br><br>
                                                                <font size="2" color="red">This is a software generated
                                                                    request. If you have already pay your invoice kindly
                                                                    ignore this email.</font><br><br>
                                                                <strong>'.$site_nameC.'</strong>
                                                                <br><br><br>'.$name.'<br>
                                                                <strong>Accounts
                                                                    '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email1.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" valign="top"
                                        ...
                                        This is an automatically generated email, please do not reply.</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
