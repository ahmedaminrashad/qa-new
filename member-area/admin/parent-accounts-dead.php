...
<a href="parent-accounts-left" class="btn red"><i class="fa fa-user-times"></i> Left (Deactivated, Dead &amp; Completed) <b>(No. <?php echo NUM("3"); ?>)</b></a>
<br><br>
<a href="parent-accounts-active" class="btn btn-xs red"><i class="fa fa-clock-o"></i> Deactivated <b>(No. <?php echo NUM("3"); ?>)</b></a>
<a href="parent-accounts-free" class="btn btn-xs yellow"><i class="fa fa-clock-o"></i> Dead <b>(No. <?php echo NUM("5"); ?>)</b></a>
<a href="parent-accounts-on-trial" class="btn btn-xs green"><i class="fa fa-clock-o"></i> Completed <b>(No. <?php echo NUM("11"); ?>)</b></a>
						...
						<div class="portlet-body">
							<div id="mytable" class="table-responsive">
								...
								<?php 
$result = mysql_query("SELECT `account`.*, `currency`.`currency_name`, `time_zone`.* FROM `account`,`currency`,`time_zone` WHERE account.currency_id=currency.currency_id and account.timezone=time_zone.tz_id and active = 3 and parent_id not in (select parent_id from invoice)");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
