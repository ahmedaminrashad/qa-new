...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{		
			...
			$parent_pack = MYSQL_RESULT($result,$i,"pack");
			$parent_amount = MYSQL_RESULT($result,$i,"amount");
?>
						<div class="timeline-item">
							<div class="timeline-body">
								...
								<div class="timeline-body-head">
									<div class="timeline-body-head-caption">
										...
										<span class="timeline-body-time font-grey-cascade"><?php echo $adate; ?> (<?php echo $atime; ?>) <?php if ($asite_id == 1){echo '<span class="label label-sm label-info" title="Registartion Form"> Registartion Student</span>';} elseif ($asite_id == 2){echo '<span class="label label-sm label-warning" title="Contact US Form"> Contact US Form</span>';} elseif ($asite_id == 3){echo '<span class="label label-sm label-danger" title="Contact US Form"> Contact US Form</span>';} elseif ($asite_id == 4){echo '<span class="label label-sm label-success" title="Subscribtion Only"> Subscribtion Only</span>';}  elseif ($asite_id == 5){echo '<span class="label label-sm label-info" title="Registartion Form"> Registartion Teacher </span>';} elseif ($asite_id == 0){echo '<a href="parent-accounts-profile?parent_id='.base64_encode($parent_id).'"><span class="label label-sm label-danger" title="Refferal">Reffered by: '.$parent_name.'</span></a>';} ?></span>
									</div>
								...
								<th>
									 <?php if ($asite_id == 5){echo 'CV';}else{echo 'Phone';}?>
								</th>
								<th>
									 Country
								</th>
								...
								<td>
									 <?php if ($asite_id == 5){echo "<a href='$aphone' target='_blank'> Link </a>";}else{echo $aphone;} ?>
								</td>
								<td>
									 <?php echo $askype; ?>
								</td>
							...
							<tr>
								<td>
								<?php if ($asite_id == 5){ echo "<strong>skills:</strong>"; }else{echo "<strong>Message:</strong>";}?>
								</td>
								<td colspan="4">
									<?php echo $amessage; ?>
								</td>
