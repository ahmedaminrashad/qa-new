...
If ($tnumberOfRows2 == 0){
 ...
 ?></h2>
						<table class="table table-hover">
								...
								<?php
// sending query
   $result = mysql_query("SELECT * FROM `class_history` WHERE date_admin = '$date_id' ORDER BY start_time_A");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
...
?>
								...
								<td> 
									 <?php echo date("g:i a", strtotime($admin_timeS));//.$sched_id; ?> (<?php echo ttm($teacher_timeS, $teacher_timeE); ?>)
								</td>
								<td>
