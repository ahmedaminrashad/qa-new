		...
		<div class="container">
			...
			<div class="portlet light">
				...
				<div class="col-md-12">
							...
							<?php 
// sending query
$result = mysql_query("SELECT * FROM note_student WHERE status = 1 ORDER BY note_id DESC;");
$counter = 0;
if (!$result) 
	{
								...
								<li class="timeline-yellow">
									...
									<div class="timeline-body">
										...
										<div class="timeline-content">
											<strong><a href="parent-accounts-profile?parent_id=<?php echo base64_encode($apid); ?>"><?php echo $asname; ?></a> <i class="fa fa-arrow-right"></i></strong> <?php echo $anote; ?>											
											</div>
										<div class="timeline-footer">
											<a href="add-note-reply?n_id=<?php echo $anid; ?>&link=<?php echo $link; ?>" class="btn green pull-right">
											Cleared <i class="m-icon-swapright m-icon-white"></i>
											</a> <a href="add-new-task-manual?parent_id=<?php echo $apid; ?>&name=<?php echo $asname; ?>&note=<?php echo $anote; ?>" class="btn red pull-right">
											Create Task <i class="m-icon-swapright m-icon-white"></i>
											</a>
										</div>
									</div>
								</li>
