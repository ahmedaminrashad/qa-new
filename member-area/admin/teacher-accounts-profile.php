					...
					<div class="tabbable tabbable-custom tabbable-noborder">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1_1">
								<div class="row">
									<div class="col-md-3">
										<ul class="list-unstyled profile-nav">
											...
											<li>
											<a href="upload-teacher-pic?ptec=<?php echo $this_profile_no; ?>&name=<?php echo $tname; ?>">Edit Picture</a>
											</li>
											<li>
											<a href="edit-teacher-account?profile_no=<?php echo $this_profile_no; ?>">Edit Profile</a>
											</li>
											<li>
											<a href="upload-teacher-doc?ptec=<?php echo $this_profile_no; ?>&name=<?php echo $tname; ?>">Upload Docs</a>
											</li>
											<li>
											...
											<li>
												<a href="teacher-salary-record?ptec=<?php echo $this_profile_no; ?>&name=<?php echo $tname; ?>&last_link=<?php echo $link; ?>">
												Salary Record </a>
											</li>
											<li>
												<a href="teacher-schedule?pT=<?php echo $this_profile_no; ?>">
												Schedule </a>
											</li>
											<li>
												<a data-target="#fine" data-toggle="modal">
												Salary Adjustment</a>
											</li>
											<li>
												<a data-target="#performance" data-toggle="modal">
												Generate Performance</a>
											</li>
											<li>
												<a data-target="#salary" data-toggle="modal">
												Generate Salary</a>
											</li>
											<li>
												<?php if ($rg_active == 1){ echo '<a href="deactivate-teacher?pteacher='.$this_profile_no.'&link='.$link.'&sts=2&stlog=8"><i class="fa fa-plus"></i> Deactivate Account</a>'; } else { echo ''; } ?>
												<?php if ($rg_active == 2){ echo '<a href="deactivate-teacher?pteacher='.$this_profile_no.'&link='.$link.'&sts=1&stlog=1001"><i class="fa fa-check"></i> Activate Account</a>'; } else { echo ''; } ?>
											</li>
										</ul>
									</div>
									<div class="col-md-9">
										<div class="row">
											<div class="profile-info">
												<h1><?php echo $tname; ?> (<?php echo $category; ?> <?php if ($rg_training == 2){ echo '<font color="FE2E2E"><b><a href="teacher-rights-training?a_id='.$this_profile_no.'&link='.$link.'&sts=1">On Training</a></b></font>'; } else {echo '';} ?>)</h1>
												<h1><a data-target="#level" data-toggle="modal"><?php if ($rg_level == 1){echo '<span class="label label-sm label-danger">Class A</span>';} elseif ($rg_level == 2){echo '<span class="label label-sm label-warning">Class B</span>';} else {echo '<span class="label label-sm label-success">Class C</span>';} ?></a>
												<a class="manager" href="#manager" data-toggle="modal" data-target="#manager" teacher-id="<?php echo $this_profile_no; ?>" manager-id="<?php echo $man_id; ?>"><span class="label label-sm label-success"><?php echo man($man_id); ?></span></a></h1>
												...
												<ul class="list-inline">
													...
													<li>
														Experience: <font color="#44B6AE"> <b><?php echo $exe; ?></b></font>
													</li>
												</ul>
													<ul class="list-inline">
													<li>
											...
											<ul class="list-inline">
											<li>
														Job: <font color="#44B6AE"> <b><?php echo $em_id; ?></b></font>
													</li>
													<li>
														Zoom: <font color="#44B6AE"> <b><?php echo $skype; ?></b></font>
													</li>
													<li>
														Zoom-Pass: <font color="#44B6AE"> <b><?php echo $skype_p; ?></b></font>
													</li>
													<li>
														Zoom-Link: <font color="#44B6AE"> <b><?php echo $zoom_link; ?></b></font>
													</li>
													<li>
														Group ID: <font color="#44B6AE"> <b><?php echo $groupid; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														Salary: <font color="#44B6AE"> <b><?php if ($sal == 1){echo 'Monthly';} elseif ($sal == 2){echo 'Per Student';} else {echo 'Per Hour';} ?></b></font>
													</li>
													<li>
														Username: <font color="#44B6AE"> <b><?php echo $user; ?></b></font>
													</li>
													<li>
														Pasword: <font color="#44B6AE"> <b><?php echo $pass; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														Timezone: <font color="#44B6AE"> <b><?php echo $tz_time; ?></b></font>
													</li>
													<li>
														Difference: <font color="#44B6AE"> <b><?php echo $tz_diff; ?></b></font>
													</li>
													<li>
														DoJ: <font color="#44B6AE"> <b><?php echo $doj; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													</ul>
											...
											<ul class="list-inline">
											<li>
														<?php if ($rg_csr == 1){echo '<a href="csr_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">CSR Rights</button></a>';} elseif ($rg_csr == 2){echo '<a href="csr_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">CSR Rights</button></a>';} ?>
													</li>
													<li>
														<?php if ($rg_teacher == 1){echo '<a href="teacher_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">Teaching Rights</button></a>';} elseif ($rg_teacher == 2){echo '<a href="teacher_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">Teaching Rights</button></a>';} ?>
													</li>
													<li>
														<?php if ($rg_manager == 1){echo '<a href="manager_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">Manager Rights</button></a>';} elseif ($rg_manager == 2){echo '<a href="manager_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">Manager Rights</button></a>';} ?>
													</li>
													<li>
														<?php if ($rg_s_manager == 1){echo '<a href="s_manager_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">Senoir Manager Rights</button></a>';} elseif ($rg_s_manager == 2){echo '<a href="s_manager_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">Senoir Manager Rights</button></a>';} ?>
													</li>
													<li>
														<?php if ($rg_accounts == 1){echo '<a href="accounts_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">Accounts Rights</button></a>';} elseif ($rg_accounts == 2){echo '<a href="accounts_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">Accounts Rights</button></a>';} ?>
													</li>
													<li>
														<?php if ($rg_billing == 1){echo '<a href="billing_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=2"><button type="button" class="btn green btn-xs">Billing Rights</button></a>';} elseif ($rg_billing == 2){echo '<a href="billing_rights?a_id='.$this_profile_no.'&link='.$link.'&sts=1"><button type="button" class="btn red btn-xs">Billings</button></a>';} ?>
													</li>
													</ul>
													</div>
													<div class="profile-info">
											...
											<ul class="list-inline">
													<li>
														Account Title: <font color="#44B6AE"> <b><?php echo $ttitle; ?></b></font>
													</li>
													<li>
														Residence ALW: <font color="#44B6AE"> <b><?php echo $trent; ?></b></font>
													</li>
													<li>
														Tax: <font color="#44B6AE"> <b><?php echo $ttax; ?></b></font>
													</li>
													<li>
														EOBI: <font color="#44B6AE"> <b><?php echo $rg_eobi; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														Monthly Salary: <font color="#44B6AE"> <b><?php echo $tsalary; ?></b></font>
													</li>
													<li>
														Class Rate: <font color="#44B6AE"> <b><?php echo $crate; ?></b></font>
													</li>
													<li>
														CSR Rate: <font color="#44B6AE"> <b><?php echo $csrrate; ?></b></font>
													</li>
													<li>
														Hour Rate: <font color="#44B6AE"> <b><?php echo $hrate; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														Medical ALW: <font color="#44B6AE"> <b><?php echo $rg_medi; ?></b></font>
													</li>
													<li>
														Entertainment ALW: <font color="#44B6AE"> <b><?php echo $rg_ent; ?></b></font>
													</li>
													<li>
														Misc. ALW: <font color="#44B6AE"> <b><?php echo $rg_misc; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														Bank: <font color="#44B6AE"> <b><?php echo $tbank; ?></b></font>
													</li>
													<li>
														Branch Code: <font color="#44B6AE"> <b><?php echo $tcode; ?></b></font>
													</li>
													<li>
														A/C No.: <font color="#44B6AE"> <b><?php echo $tno; ?></b></font>
													</li>
													</ul>
													<ul class="list-inline">
													<li>
														<a data-target="#bank" data-toggle="modal"><button type="button" class="btn yellow btn-xs"><i class="fa fa-edit"></i> Add/Edit Bank Details</button></a>
													</li>
													</ul>
											</div>
											<div class="profile-info">
											...
											<div class="profile-info">
											<h1>Ducoment Available (View Uploads)</h1>
											<ul class="list-inline">
											<li>
												<?php if ($witness_id1 == 1){echo '<a href="clear-w1?a_id='.$this_profile_no.'&link='.$link.'"><button type="button" class="btn red btn-xs">Witness 01</button></a>';} elseif ($witness_id1 == 2){echo '<span class="label label-sm label-success">Witness 01</span>';} ?>
													</li>
													<li>
												<?php if ($witness_id2 == 1){echo '<a href="clear-w2?a_id='.$this_profile_no.'&link='.$link.'"><button type="button" class="btn red btn-xs">Witness 02</button></a>';} elseif ($witness_id2 == 2){echo '<span class="label label-sm label-success">Witness 02</span>';} ?>
													</li>
													<li>
												<?php if ($cheque_id == 1){echo '<a href="clear-cheque?a_id='.$this_profile_no.'&link='.$link.'"><button type="button" class="btn red btn-xs">Security Cheque</button></a>';} elseif ($cheque_id == 2){echo '<span class="label label-sm label-success">Security Cheque</span>';} ?>
													</li>
													<li>
												<?php if ($agree_id == 1){echo '<a href="clear-agree?a_id='.$this_profile_no.'&link='.$link.'"><button type="button" class="btn red btn-xs">Agreement</button></a>';} elseif ($agree_id == 2){echo '<span class="label label-sm label-success">Agreement</span>';} ?>
													</li>
													</ul>
											</div>
											<div class="profile-info">
											<h1>Ducoments for Print</h1>
											<ul class="list-inline">
											<li>
												<a href="employment-agreement<?php echo $sal; ?>?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>"><button type="button" class="btn yellow btn-xs">Print Agreement</button></a>
													</li>
													<li>
												<a href="witness-form?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>"><button type="button" class="btn yellow btn-xs">Print Witness Form</button></a>
													</li>
													<li>
												<a href="account-request?tech_name=<?php echo $tname; ?>&tech_doj=<?php echo $doj; ?>&tech_cnic=<?php echo $cnic; ?>&tech_father=<?php echo $fname; ?>&tech_gender=<?php echo $gender; ?>"><button type="button" class="btn yellow btn-xs">Print Account Request</button></a>
													</li>
													</ul>
											</div>
											<!--end col-md-8-->
										...
										<div class="tabbable tabbable-custom tabbable-custom-profile">
											<ul class="nav nav-tabs">
												...
												<li>
													...
													Current month Deductions </a>
												</li>
												<li>
													<a href="#tab_1_44" data-toggle="tab">
													Current month Leaves </a>
												</li>
											</ul>
											<div class="tab-content">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM teacher_salary WHERE teacher_id = $ptec");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{		
			...
			$class_num = MYSQL_RESULT($result,$i,"total_classes");
			$class_hour = MYSQL_RESULT($result,$i,"total_hours");
			$stu_num = MYSQL_RESULT($result,$i,"num_student");
			//earning
			...
			$t_name = MYSQL_RESULT($result,$i,"teacher_name");
			$date_start = MYSQL_RESULT($result,$i,"date1");
			$date_end = MYSQL_RESULT($result,$i,"date2");
			$currency1 = MYSQL_RESULT($result,$i,"currency");
...
?>
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM teacher_fine WHERE teacher_id = $ptec AND YEAR(date) = $sy AND MONTH(date) = $c_month");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
?>
								...
								<td><a href="delete-fine?cid=<?php echo $fine_id; ?>"><button type="button" class="btn red btn-xs">Delete</button></a></td>
							</tr>
							<?php 	
		$i++;		
		}
...
?>
							...
							<div id="mytable" class="table-responsive">
								...
								<?php 
// sending query
$result = mysql_query("SELECT * FROM teacher_attendance WHERE teacher_id = $ptec AND YEAR(date) = $sy AND MONTH(date) = $c_month AND status = 2");
$counter = 0;
if (!$result) 
	{
    die("Query to show fields from table failed");
...
If ($numberOfRows == 0) 
	{
	echo '<b class="green">No Leave Found in '.$c_month.'-'.$sy.'</b>';
	}
else if ($numberOfRows > 0) 
	{
	$i=0;
...
?>
					...
					<div class="modal fade" id="bank" tabindex="-1" role="dialog" aria-hidden="true">
									...
									<div class="portlet-body form">
										...
										<form action="edit-bank-teacher" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Monthly Salary</strong></label>
															<div class="col-md-7">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>WhatsApp Group</strong></label>
															<div class="col-md-7">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Medi. Allow.</strong></label>
															<div class="col-md-7">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Entertainment Allow.</strong></label>
															<div class="col-md-7">
												...
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Misc. Allow.</strong></label>
															<div class="col-md-7">
								...
								<!--salary modal start-->
					<div class="modal fade" id="performance" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title">Generate Performance</h4>
										</div>
										<div class="modal-body">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Generate Performance for <?php echo $tname; ?>
										</div>
										<div class="tools">
											<a href="javascript:;" class="collapse">
											</a>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="add-teacher-performance" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												<div class="form-group">
															<label class="control-label col-md-3">
									...
									<div class="portlet-body form">
										...
										<form action="<?php if ($sal == 3){echo 'generate-salary-per-hour';} elseif($sal == 4){echo 'generate-salary-per-slot';} else{echo 'generate-salary';} ?>" method="post" class="form-horizontal form-row-seperated">
											...
											<div class="form-group">
															...
															<div class="col-md-4">
															<input type="date" name="date1" id="date1" class="form-control input-circle" required></input>
															</div>
												</div>
												<div class="form-group">
															<label class="control-label col-md-3">
															...
															<div class="col-md-4">
															<input type="date" name="date2" id="date2" class="form-control input-circle" required></input>
															</div>
												</div>
												<div class="form-group">
															<label class="control-label col-md-3">
  ...
  <?php } while ($row = mysql_fetch_assoc($result)); ?>
												...
												<input type="hidden" value="<?php echo $cat; ?>" name="type_cat" id="type_cat" class="form-control input-circle"></input>
												<input type="hidden" value="<?php if ($cat == 7 OR $cat == 8) { echo '7'; } else { echo '8'; } ?>" name="ac_cat" id="ac_cat" class="form-control input-circle"></input>
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="submit" name="cmdSubmit" class="btn btn-circle blue">
					...
					<div class="modal fade" id="level" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title">Assign Level</h4>
										</div>
										<div class="modal-body">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-plus"></i>Assign Level <?php echo $tname; ?>
										</div>
										<div class="tools">
											<a href="javascript:;" class="collapse">
											</a>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="assign-level" method="post" class="form-horizontal form-row-seperated">
											<div class="form-body">
												<div class="form-group">
															<label class="control-label col-md-3">
															<strong>Select Level</strong></label>
															<div class="col-md-4">
															<select required class="form-control input-circle" name="level"  id="level" onchange="javascript: return optionList49_SelectedIndex()">
												...
												<input type="hidden" value="<?php echo $this_profile_no; ?>" name="a_id" id="a_id" class="form-control input-circle"></input>
												<input type="hidden" value="<?php echo $link; ?>" name="t_link" id="t_link" class="form-control input-circle"></input>
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
			...
			<div class="modal fade bs-modal-lg" id="manager" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
...
$('.manager').click(function(){
    ...
    var famMAN=$(this).attr('manager-id');
    $.ajax({url:"change-manager.php?famTECH="+famTECH+"&famMAN="+famMAN,cache:false,success:function(result){
