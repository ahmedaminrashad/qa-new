...
$dat2 =$_REQUEST['date2'];
$thourrate =$_REQUEST['hour_rate'];
$result = mysql_query("SELECT * FROM class_history WHERE (monitor_id = 9 OR monitor_id = 4 OR monitor_id = 6 OR monitor_id = 21) AND re_status != 2 AND teacher_id = '$t' AND date_admin >= '$dat1' AND date_admin <= '$dat2'");
if (!$result) 
	{
    die("Query to show fields from table failed");
	}
$tnumberOfRows = MYSQL_NUMROWS($result);
$slot = $tnumberOfRows/2;

$result1 = mysql_query("SELECT * FROM slot_rate WHERE slot_rate <= '$slot'");
if (!$result1) 
	{
    die("Query to show fields from table failed");
	}
...
$result3 = mysql_query("SELECT * FROM slot_rate WHERE slot_id = '$tnumberOfRows1'");
if (!$result3) 
	{
    die("Query to show fields from table failed");
	}
$tnumberOfRows3 = MYSQL_NUMROWS($result3);
If ($tnumberOfRows3 == 0){
			echo ''.$slot.' 0';
			}
		else if ($tnumberOfRows3 > 0) 
			{
					$slotSalary = MYSQL_RESULT($result3,$i,"slot_salary");
					$slotRate = MYSQL_RESULT($result3,$i,"slot_rate");
	
			  		if ($a == 2) {echo '<span title="Slot Number">'.$tnumberOfRows1.'</span> <span title="Slot Rate">'.$slotRate.'</span> <span title="Slot Salary">'.$slot.'<span>';}
			  		elseif ($a == 1) {echo $slotSalary;}
			  		elseif ($a == 3) {echo $slotRate;}
			  		elseif ($a == 4) {echo $slot;}
			}
}
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					 Generate Salary for (<?php echo $dat1; ?> - <?php echo $dat2; ?>)
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
									...
									<div class="portlet-body form">
										...
										<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo $tsalary; ?>" name="teacher_salary" id="teacher_salary" class="form-control input-circle" readonly>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Earning Per Slot</strong> (<?php echo hour_earning("2", "$tid"); ?>)</label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo hour_earning("1", "$tid"); ?>" name="slot_salary" id="slot_salary" class="form-control input-circle" readonly>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo csr_earning("1", "$tid"); ?>" name="csr_salary" id="csr_salary" class="form-control input-circle" readonly>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Company Returns</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo fine("$tid", "4"); ?>" name="teacher_returns" id="teacher_returns" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Performance Bonus</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo fine("$tid", "2"); ?>" name="teacher_bouns" id="teacher_bouns" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Residence Allowance</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo $trent; ?>" name="teacher_rent" id="teacher_rent" class="form-control input-circle" readonly>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Fine</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo fine("$tid", "1"); ?>" name="teacher_fine" id="teacher_fine" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Reduction in Fine</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo fine("$tid", "5"); ?>" name="teacher_reduc" id="teacher_reduc" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Leave Deduction</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo leave_duc("$tid", "2", "$tsalary"); ?>" name="teacher_leave" id="teacher_leave" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Advance Deduction</strong></label>
													<div class="col-md-4">
														<input class="txt" type="text" value="<?php echo fine("$tid", "3"); ?>" name="teacher_advance" id="teacher_advance" class="form-control input-circle">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label class="col-md-3 control-label"><strong>Total</strong></label>
													<div class="col-md-4">
														<input type="text" id='sum1' name="input" class="form-control input-circle" readonly>
													</div>
												</div>
												...
												<input type="hidden" value="<?php echo hour_earning("3", "$tid"); ?>" name="tech_sl_rate" id="tech_sl_rate" class="form-control input-circle">
												...
												<input type="hidden" value="<?php echo hour_earning("4", "$tid"); ?>" name="total_hours" id="total_hours" class="form-control input-circle">
