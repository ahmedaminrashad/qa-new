...
$subject = 'A Student Activated in Your Account at www.qarabic.Com';
$first_line = 'Following action has been taken to your account at www.qarabic.Com';
$first_para = 'This is a confirmation email that we have activated student <strong>Respected '.$sname.'</strong> in your account. If you have any question in this regard, feel free to ask anything.';
