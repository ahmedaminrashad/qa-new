...
$subject = 'Classes Unsuspended at www.Qarabic.Com';
$first_line = 'Following action has been taken to your account at www.Qarabic.Com';
$first_para = 'This is a confirmation email that we have unsuspended the classes of student <strong>Respected '.$sname.'</strong> in your account. If you have any question in this regard, feel free to ask anything.';
