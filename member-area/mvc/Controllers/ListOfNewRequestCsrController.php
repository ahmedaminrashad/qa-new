<?php
/**
 * ListOfNewRequestCsr Controller
 * Migrated from list-of-new-request-csr.php
 */
class ListOfNewRequestCsr extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-new-request-csr', $data);
    }
