<?php
/**
 * ListOfNewRequestTeaching Controller
 * Migrated from list-of-new-request-teaching.php
 */
class ListOfNewRequestTeaching extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-new-request-teaching', $data);
    }
