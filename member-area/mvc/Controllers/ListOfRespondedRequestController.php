<?php
/**
 * ListOfRespondedRequest Controller
 * Migrated from list-of-responded-request.php
 */
class ListOfRespondedRequest extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-responded-request', $data);
    }
