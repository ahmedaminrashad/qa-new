<?php
/**
 * TeacherSearchLocalTime Controller
 * Migrated from teacher-search-local-time.php
 */
class TeacherSearchLocalTime extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/teacher-search-local-time', $data);
    }
