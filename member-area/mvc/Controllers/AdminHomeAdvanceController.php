<?php
/**
 * AdminHomeAdvance Controller
 * Migrated from admin-home-advance.php
 */
class AdminHomeAdvance extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-advance', $data);
    }
