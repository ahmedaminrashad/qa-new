<?php
/**
 * CurrentAnnouncement Controller
 * Migrated from current-announcement.php
 */
class CurrentAnnouncement extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/current-announcement', $data);
    }
