<?php
/**
 * MonthlySalaryDetails Controller
 * Migrated from monthly-salary-details.php
 */
class MonthlySalaryDetails extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/monthly-salary-details', $data);
    }
