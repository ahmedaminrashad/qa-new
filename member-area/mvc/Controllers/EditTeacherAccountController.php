<?php
/**
 * EditTeacherAccount Controller
 * Migrated from edit-teacher-account.php
 */
class EditTeacherAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/edit-teacher-account', $data);
    }
