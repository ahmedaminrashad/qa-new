<?php
/**
 * ListOfFeePackages Controller
 * Migrated from list-of-fee-packages.php
 */
class ListOfFeePackages extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-fee-packages', $data);
    }
