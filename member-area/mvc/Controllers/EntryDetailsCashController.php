<?php
/**
 * EntryDetailsCash Controller
 * Migrated from entry-details-cash.php
 */
class EntryDetailsCash extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/entry-details-cash', $data);
    }
