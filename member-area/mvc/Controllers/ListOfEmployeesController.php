<?php
/**
 * ListOfEmployees Controller
 * Migrated from list-of-employees.php
 */
class ListOfEmployees extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-employees', $data);
    }
