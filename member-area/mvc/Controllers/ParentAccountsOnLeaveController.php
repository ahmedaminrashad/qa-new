<?php
/**
 * ParentAccountsOnLeave Controller
 * Migrated from parent-accounts-on-leave.php
 */
class ParentAccountsOnLeave extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-on-leave', $data);
    }
