<?php
/**
 * AddAccountEntry Controller
 * Migrated from add-account-entry.php
 */
class AddAccountEntry extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/add-account-entry', $data);
    }
