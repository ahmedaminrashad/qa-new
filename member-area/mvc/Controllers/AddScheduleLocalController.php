<?php
/**
 * AddScheduleLocal Controller
 * Migrated from add-schedule-local.php
 */
class AddScheduleLocal extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/add-schedule-local', $data);
    }
