<?php
/**
 * ExpenseReportDetailsIncome Controller
 * Migrated from expense-report-details-income.php
 */
class ExpenseReportDetailsIncome extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/expense-report-details-income', $data);
    }
