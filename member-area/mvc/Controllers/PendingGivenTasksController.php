<?php
/**
 * PendingGivenTasks Controller
 * Migrated from pending-given-tasks.php
 */
class PendingGivenTasks extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/pending-given-tasks', $data);
    }
