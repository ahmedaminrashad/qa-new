<?php
/**
 * ListOfTeachers Controller
 * Migrated from list-of-teachers.php
 */
class ListOfTeachersController extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-teachers', $data);
    }
