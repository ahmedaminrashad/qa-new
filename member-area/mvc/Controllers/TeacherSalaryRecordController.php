<?php
/**
 * TeacherSalaryRecord Controller
 * Migrated from teacher-salary-record.php
 */
class TeacherSalaryRecord extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/teacher-salary-record', $data);
    }
