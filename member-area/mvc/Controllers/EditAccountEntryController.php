<?php
/**
 * EditAccountEntry Controller
 * Migrated from edit-account-entry.php
 */
class EditAccountEntry extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/edit-account-entry', $data);
    }
