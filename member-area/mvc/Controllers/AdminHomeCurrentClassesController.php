<?php
/**
 * AdminHomeCurrentClasses Controller
 * Migrated from admin-home-current-classes.php
 */
class AdminHomeCurrentClasses extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-current-classes', $data);
    }
