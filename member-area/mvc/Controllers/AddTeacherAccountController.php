<?php
/**
 * AddTeacherAccount Controller
 * Migrated from add-teacher-account.php
 */
class AddTeacherAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/add-teacher-account', $data);
    }
