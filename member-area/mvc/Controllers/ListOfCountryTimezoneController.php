<?php
/**
 * ListOfCountryTimezone Controller
 * Migrated from list-of-country-timezone.php
 */
class ListOfCountryTimezone extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-country-timezone', $data);
    }
