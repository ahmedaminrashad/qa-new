<?php
/**
 * ComplaintPending Controller
 * Migrated from complaint-pending.php
 */
class ComplaintPending extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/complaint-pending', $data);
    }
