<?php
/**
 * ComplaintCompleted Controller
 * Migrated from complaint-completed.php
 */
class ComplaintCompleted extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/complaint-completed', $data);
    }
