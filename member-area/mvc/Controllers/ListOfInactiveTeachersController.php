<?php
/**
 * ListOfInactiveTeachers Controller
 * Migrated from list-of-inactive-teachers.php
 */
class ListOfInactiveTeachers extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-inactive-teachers', $data);
    }
