<?php
/**
 * MonthlySalaryRecord Controller
 * Migrated from monthly-salary-record.php
 */
class MonthlySalaryRecord extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/monthly-salary-record', $data);
    }
