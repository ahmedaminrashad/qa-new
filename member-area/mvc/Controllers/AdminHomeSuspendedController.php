<?php
/**
 * AdminHomeSuspended Controller
 * Migrated from admin-home-suspended.php
 */
class AdminHomeSuspended extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-suspended', $data);
    }
