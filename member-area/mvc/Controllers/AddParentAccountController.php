<?php
/**
 * AddParentAccount Controller
 * Migrated from add-parent-account.php
 */
class AddParentAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/add-parent-account', $data);
    }
