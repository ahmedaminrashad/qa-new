<?php
/**
 * TeacherPerformance Controller
 * Migrated from teacher-performance.php
 */
class TeacherPerformance extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/teacher-performance', $data);
    }
