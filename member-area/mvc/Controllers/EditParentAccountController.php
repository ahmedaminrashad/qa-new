<?php
/**
 * EditParentAccount Controller
 * Migrated from edit-parent-account.php
 */
class EditParentAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/edit-parent-account', $data);
    }
