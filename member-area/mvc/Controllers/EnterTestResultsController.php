<?php
/**
 * EnterTestResults Controller
 * Migrated from enter_test_results.php
 */
class EnterTestResults extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/enter_test_results', $data);
    }
