<?php
/**
 * AdminHomeTakenClasses Controller
 * Migrated from admin-home-taken-classes.php
 */
class AdminHomeTakenClasses extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-taken-classes', $data);
    }
