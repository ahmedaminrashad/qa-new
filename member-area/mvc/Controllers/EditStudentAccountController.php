<?php
/**
 * EditStudentAccount Controller
 * Migrated from edit-student-account.php
 */
class EditStudentAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/edit-student-account', $data);
    }
