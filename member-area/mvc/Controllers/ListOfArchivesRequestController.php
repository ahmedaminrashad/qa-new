<?php
/**
 * ListOfArchivesRequest Controller
 * Migrated from list-of-archives-request.php
 */
class ListOfArchivesRequest extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-archives-request', $data);
    }
