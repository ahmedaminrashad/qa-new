<?php
/**
 * AddStudentAccount Controller
 * Migrated from add-student-account.php
 */
class AddStudentAccount extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/add-student-account', $data);
    }
