<?php
/**
 * ParentAccountsOnTrial Controller
 * Migrated from parent-accounts-on-trial.php
 */
class ParentAccountsOnTrial extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-on-trial', $data);
    }
