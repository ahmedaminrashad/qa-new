<?php
/**
 * CreateDailyClasses Controller
 * Migrated from create_daily_classes.php
 */
class CreateDailyClasses extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/create_daily_classes', $data);
    }
