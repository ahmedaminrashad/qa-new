<?php
/**
 * RevenueExpenseReport Controller
 * Migrated from revenue-expense-report.php
 */
class RevenueExpenseReport extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/revenue-expense-report', $data);
    }
