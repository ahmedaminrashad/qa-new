<?php
/**
 * AwaitingGivenTasks Controller
 * Migrated from awaiting-given-tasks.php
 */
class AwaitingGivenTasks extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/awaiting-given-tasks', $data);
    }
