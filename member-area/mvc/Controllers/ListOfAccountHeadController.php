<?php
/**
 * ListOfAccountHead Controller
 * Migrated from list-of-account-head.php
 */
class ListOfAccountHead extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-account-head', $data);
    }
