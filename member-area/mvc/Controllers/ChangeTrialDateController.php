<?php
/**
 * ChangeTrialDate Controller
 * Migrated from change-trial-date.php
 */
class ChangeTrialDate extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/change-trial-date', $data);
    }
