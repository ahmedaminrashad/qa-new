<?php
/**
 * AwaitingIssuedTasks Controller
 * Migrated from awaiting-issued-tasks.php
 */
class AwaitingIssuedTasks extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/awaiting-issued-tasks', $data);
    }
