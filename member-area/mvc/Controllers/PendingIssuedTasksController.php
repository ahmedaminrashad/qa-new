<?php
/**
 * PendingIssuedTasks Controller
 * Migrated from pending-issued-tasks.php
 */
class PendingIssuedTasks extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/pending-issued-tasks', $data);
    }
