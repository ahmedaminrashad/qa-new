<?php
/**
 * ExpenseReportDetails Controller
 * Migrated from expense-report-details.php
 */
class ExpenseReportDetails extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/expense-report-details', $data);
    }
