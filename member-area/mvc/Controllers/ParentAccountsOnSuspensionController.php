<?php
/**
 * ParentAccountsOnSuspension Controller
 * Migrated from parent-accounts-on-suspension.php
 */
class ParentAccountsOnSuspension extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-on-suspension', $data);
    }
