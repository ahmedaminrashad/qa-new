<?php
/**
 * ParentAccountsDeactive Controller
 * Migrated from parent-accounts-deactive.php
 */
class ParentAccountsDeactive extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-deactive', $data);
    }
