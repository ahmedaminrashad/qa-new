<?php
/**
 * EntryDetailsYear Controller
 * Migrated from entry-details-year.php
 */
class EntryDetailsYear extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/entry-details-year', $data);
    }
