<?php
/**
 * AdminHomeRescheduled Controller
 * Migrated from admin-home-rescheduled.php
 */
class AdminHomeRescheduled extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-rescheduled', $data);
    }
