<?php
/**
 * CreateMonthlyInvoice Controller
 * Migrated from create-monthly-invoice.php
 */
class CreateMonthlyInvoice extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/create-monthly-invoice', $data);
    }
