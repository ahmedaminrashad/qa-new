<?php
/**
 * ParentAccountsActive Controller
 * Migrated from parent-accounts-active.php
 */
class ParentAccountsActive extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-active', $data);
    }
