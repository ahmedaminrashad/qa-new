<?php
/**
 * AdminHomeAbsents Controller
 * Migrated from admin-home-absents.php
 */
class AdminHomeAbsents extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/admin-home-absents', $data);
    }
