<?php
/**
 * CreateRecurringInvoice Controller
 * Migrated from create-recurring-invoice.php
 */
class CreateRecurringInvoice extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/create-recurring-invoice', $data);
    }
