<?php
/**
 * ParentAccountsProfile Controller
 * Migrated from parent-accounts-profile.php
 */
class ParentAccountsProfile extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-profile', $data);
    }
