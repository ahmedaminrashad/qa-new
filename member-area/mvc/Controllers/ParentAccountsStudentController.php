<?php
/**
 * ParentAccountsStudent Controller
 * Migrated from parent-accounts-student.php
 */
class ParentAccountsStudent extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/parent-accounts-student', $data);
    }
