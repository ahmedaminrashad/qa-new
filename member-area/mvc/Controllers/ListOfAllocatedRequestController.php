<?php
/**
 * ListOfAllocatedRequest Controller
 * Migrated from list-of-allocated-request.php
 */
class ListOfAllocatedRequest extends Controller {
    ...
    public function index() {
        ...
        $this->renderLegacyView('admin/list-of-allocated-request', $data);
    }
