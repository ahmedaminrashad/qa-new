		...
		elseif ($numberOfRows > 0) 
			...
			while ($row = mysqli_fetch_assoc($result)){			
					...
					$duration = $row['duration'];
			  		echo "<b>Teacher:</b> ".$hidden_pt."<br><b>Time:</b> ".date("g:i a", strtotime($tt1))."<br><b>Duration:</b> ".$duration."<br><b>Day:</b> ".$hidden_ptime2."";
			}
			}
	}
function color($d, $t){
...
<div class="app-main__outer">
            ...
            <!-- App inner start-->
				...
				$Course_ID =base64_decode($_GET["pT"]);
...
$numberOfRows = mysqli_num_rows($result);
		...
		elseif ($numberOfRows > 0) 
			...
			while ($row = mysqli_fetch_assoc($result)){			
					$hidden_pcourse = $row['course_yrSec'];
					echo 'Weekly Schedule for '.$hidden_pcourse.'';
			}
			}				
				?></h5>
