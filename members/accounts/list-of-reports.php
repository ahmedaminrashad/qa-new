                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
								...
								<?php 
// sending query
$sql = "SELECT * FROM `reports` WHERE status = 2 AND course_id = '$ccc' ORDER BY date DESC";
$counter = 0;
...
?>
								...
								<td>
									 <a href="report-details?ID=<?php echo $Report_ID; ?>"><button class="mb-2 mr-2 btn btn-outline-success">See Report</button></a>
								</td>
							</tr>
							<?php 	
		}
