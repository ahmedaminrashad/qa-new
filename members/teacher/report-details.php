                    ...
                    <div class="row">
                        <div class="col-lg-12">
							...
							<div class="table-responsive">
								...
								<?php if ($noorani_qaida == 1) { echo '<th>Noorani Qaida</th>'; } ?>
								<?php if ($quran_reading == 1) { echo '<th>Quran Reading</th>'; } ?>
								<?php if ($tajweed_rules == 1) { echo '<th>Tajweed Rules</th>'; } ?>
								<?php if ($memorization == 1) { echo '<th>Memorization
								</th>'; } ?>
								<?php if ($revision == 1) { echo '<th>Revision
								</th>'; } ?>
								<?php if ($ijaazah == 1) { echo '<th>Ijazah
								</th>'; } ?>
								<?php if ($studies == 1) { echo '<th>Islamic Studies
								</th>'; } ?>
								<?php if ($supplication == 1) { echo '<th>Supplication
								</th>'; } ?>
								<?php if ($arabic == 1) { echo '<th>Arabic
								</th>'; } ?>
							</tr>
								</thead>
								<tbody>
