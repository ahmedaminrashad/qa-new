					...
					<div class="vertical-timeline-item vertical-timeline-element">
                                                    <div>
                                                        ...
                                                        <div class="vertical-timeline-element-content bounce-in">
                                                            <h4 class="timeline-title"><?php if ($status == 1){ echo '<span class="text-danger">Action Pending from your side...</span>'; } elseif ($status == 2){ echo '<span class="text-success">No Action Required from your side...</span>';} ?></h4>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="signupForm" class="col-md-10 mx-auto" method="post" action="add-new-comment-given-task">
...
<div class="modal fade bd-example-modal-lg" id="task" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="re-allocate-issued-task" class="col-md-10 mx-auto" method="post" action="add-new-comment-issued-task">
												<div class="form-group">
															<label>Level</label>
															<div>
