...
?>
<?php
$page_title = 'Daily Class Report';
$page_subtitle = 'Daily Class Report';
$table_name = 'Daily Class Report';
?>
...
?>							
								...
								elseif ($mnp == 2){echo "<a href='#'><button type='button' style='width: 75px' class='mb-2 mr-2 btn btn-outline-success'>Start</button></a>";} 
								elseif ($mnp == 9) { echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-success disabled">Taken</button>'; } 
								elseif ($mnp == 4) { echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-danger disabled">Absent</button>'; } 
								elseif ($mnp == 5) { echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-info disabled">On Leave</button>'; }
								elseif ($mnp == 6){echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-danger disabled">Declined</button>';}
								elseif ($mnp == 7){echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-danger disabled">Pending</button>';}
								elseif ($mnp == 8){echo '<button type="button" style="width: 75px" class="mb-2 mr-2 btn btn-outline-danger disabled">Advance</button>';}
								elseif ($mnp == 3 && $dept_id != 3) {echo "<button type='button' style='width: 75px' class='btn yellow btn-xs'>End</button>";} elseif ($mnp == 3 && $dept_id == 3) {echo "<button type='button' style='width: 75px' class='mb-2 mr-2 btn btn-outline-warning'>End</button>";} ?>
								<?php if ($mnp == 2) {echo "<button type='button' style='width: 75px' class='mb-2 mr-2 btn btn-outline-danger'>Absent</button>";} else {echo "";} ?>
								<?php if ($mnp == 2) {echo "<button type='button' style='width: 75px' class='mb-2 mr-2 btn btn-outline-info'>Leave</button>";} else {echo "";} ?>
								<?php if ($mnp == 2 OR $mnp == 3) {echo "<button type='button' class='mb-2 mr-2 btn btn-outline-danger'><i class='fa fa-frown-o'></i></button>";} ?> <?php if ($mnp == 2 OR $mnp == 3) {echo "<button type='button' class='mb-2 mr-2 btn btn-outline-warning'><i class='fa fa-check'></i></button></a>";} ?></td>
