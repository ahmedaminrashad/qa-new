...
$famID=$_GET['famID'];
$sql = "SELECT `class_history`.*,`course`.`course_yrSec`,`profile`.`teacher_name` FROM `class_history`,`course`,`profile` WHERE class_history.course_id=course.course_id and class_history.teacher_id=profile.teacher_id
...
<div class="modal-header">
            ...
            <div class="modal-body">
                <form id="signupForm" class="col-md-10 mx-auto" method="post" action="save-advance-schedule-class">
