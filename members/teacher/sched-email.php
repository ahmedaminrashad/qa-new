...
//You'll need to alter this to match your database
 //This iterator syntax only works in PHP 5.4+
    $mail->addAddress('fearfarooq@gmail.com', 'Admin ArabianTongue.com');
                  ...
                  <tr>
                    <td align="center" valign="top" style="border-top-left-radius: 4px; border-top-right-radius: 4px; overflow: hidden; padding: 0 20px;background: #302f35;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 32px; mso-line-height-rule: exactly; line-height: 32px; font-weight: 400; letter-spacing: 1px;color: #ffffff;">Account Suspended</td>
                        </tr>
                        <tr>
                          <td height="30" style="height: 30px; line-height:30px;"></td>
                        </tr>
                  ...
                  <tr>
                    <td align="center" valign="top" style="padding: 0 20px;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 22px; font-weight: 400;color: #302f35;">Subscribed Hours Completed.</td> 
                        </tr>
                        <tr> 
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                ...
                                Subscrib Hours of the following account has been completed.<br><br>
                                Name: '.$name.'
								<br>Email: '.$email.'<br></font><br><br>
<strong>QuranSheikh.com</strong>
                                <br><br><br>'.$name.'<br>
<strong>Admin QuranSheikh.com</strong><br>www.QuranSheikh.com<br>E-mail:'.$email2.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
                                </td>
                              </tr>
                            </table>
                          </td>
