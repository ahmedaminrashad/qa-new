...
require ("../includes/dbconnection.php");
$sql = "SELECT * FROM task_creator WHERE clear = '$var1' AND from_person = '$var2' AND status = '$var3'";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
			echo '0';
...
require ("../includes/dbconnection.php");
$sql = "SELECT * FROM task_creator WHERE clear = '$var1' AND from_person = '$var2'";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
			echo '0';
                                    ...
                                    <div class="mb-3 card">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-eg9-0" role="tabpanel">
                                                ...
                                                <?php 
// sending query
$sql = "SELECT * FROM task_creator WHERE clear = '1' AND from_person = '$ID' AND status = '2' ORDER BY task_id DESC";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
?>
                                    ...
                                    <div class="card-hover-shadow-2x mb-3 card">
                                        <div class="card-header">From: <?php echo TeacherName("$per_from",'1'); ?> To: <?php echo TeacherName("$per_to",'1'); ?> <?php if ($pid > 0){echo '<font color="#44B6AE">&nbsp;  (Family Name: '.$pname.'</font>)';} else {echo '';} ?></div>
...
?>
                                            ...
                                            <div class="tab-pane" id="tab-eg9-1" role="tabpanel">
                                                ...
                                                <?php 
// sending query
$sql = "SELECT * FROM task_creator WHERE clear = '1' AND from_person = '$ID' AND status = '1' ORDER BY task_id DESC";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
?>
                                            ...
                                            <div class="tab-pane" id="tab-eg9-2" role="tabpanel">
                                                ...
                                                <?php 
// sending query
$sql = "SELECT * FROM task_creator WHERE clear = '2' AND from_person = '$ID' ORDER BY task_id DESC";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
