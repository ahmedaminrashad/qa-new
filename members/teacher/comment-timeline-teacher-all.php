<?php session_start(); ?>
  ...
  $tt = $_SESSION['is']['teacher_id'];
   $sql = "UPDATE note_student SET status = '3' WHERE status = '2' AND teacher_id = '$tt'";
            ...
            <!-- App inner start-->
                ...
                <!-- Page Title Start-->
                    ...
                    <div class="row">
							...
							<?php 
// sending query
$sql = "SELECT * FROM note_student WHERE status > 1 AND teacher_id = '$tt' ORDER BY note_id DESC";
$counter = 0;
