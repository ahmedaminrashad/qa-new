...
$result = mysqli_query($mysql, "SELECT * FROM `invoice` WHERE status = '1' AND mon_id = '$mid' AND y_id = '$yid' AND currency_id = '$cid'");
                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
                                    <tr>
                                      <td colspan="2" align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">Billing Details:</td>
                                    </tr> 
                                  	<!-- #{BeginInfo} -->
                                    <tr> 
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">Month:</td>
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">'.$m.'-'.$y.'</td>
                                    </tr>
                                    <tr> 
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">Amount:</td>
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">'.$cidS.' '.$feeF.'</td>
                                    </tr>
                                    <tr> 
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;">Due Date:</td>
                                      <td align="left" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">'.$dataF.'</td>
                                    </tr>
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="padding: 10px 10px 10px 10px;font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;font-weight: 700; width: 208px;"><br><font color="blue">Kindly pay your invoice by clicking on PAY NOW button below. We have made it easy for you.</font></td>
                                    </tr>
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;"><br><a href="https://'.$site_nameS.'/member-area/accounts/direct-payment-link?py_id='.base64_encode($row['py_id']).'" ><button class="button" style="vertical-align:middle"><span><b>PAY NOW</b></span></button></a></td>
                                    </tr>
                                  	<!-- #{EndInfo} -->                                    
                                  </table>
                                </td>
...
<strong>Accounts '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email2.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
    ...
    if (!$mail->send()) {
        ...
        echo "Message sent to :" . $row['parent_name'] . ' (' . str_replace("@", "&#64;", $row['email']) . ') at '.$time_start.' <a href="invoice-details">Go to Invoice Details</a><br />';
