<?php
  require ('../includes/dbconnection.php');
		...
		$mp =$_REQUEST['mp_id'];
			$sql = "UPDATE class_history SET date_teacher = '$tdate', date_student = '$sdate', time_s_id = '$t_timee', stime_s_id = '$s_timee', date_admin = '$adate', atime_s_id = '$a_timee', status = '18' WHERE history_id = '$history'";
