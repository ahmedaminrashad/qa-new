...
if($dept_id == 8 && $active == 1){
		...
		$_SESSION['is']['dept'] = $dept_id;
		$_SESSION['is']['deg'] = 'Teacher';
		$session = "1";	
 echo "<script>window.open('../teacher/teacher-home','_self')</script>";
				   }
elseif($dept_id == 4 && $active == 1){
		session_start();
		$_SESSION['is']['login']    = TRUE;
		...
		$_SESSION['is']['anu_type'] = $anu;
		$_SESSION['is']['dept'] = $dept_id;
		$_SESSION['is']['deg'] = 'Admin';
		$session = "1";	
 echo "<script>window.open('dashboard','_self')</script>";
				   }
				   elseif($dept_id == 5 && $active == 1){
		session_start();
		$_SESSION['is']['login']    = TRUE;
		$_SESSION['is']['username1'] = $_POST['username'];
		$_SESSION['is']['teacher_id'] = $teacher_id;
		...
		$_SESSION['is']['anu_type'] = $anu;
		$_SESSION['is']['dept'] = $dept_id;
		$_SESSION['is']['deg'] = 'Senior Manager';
		$session = "1";	
 echo "<script>window.open('dashboard','_self')</script>";
				   }
}
