...
<?php
$sy = date('Y-m-d');
$page_title = 'Teacher Salary Record';
$page_subtitle = 'Teacher Salary Record for '.$name_id.'';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
								...
								<tr>
								<th>
									 <div class="label label-info"><a href="teacher-accounts-profile?profile_no=<?php echo base64_encode($tech_id); ?>"><?php echo $name_id; ?></a></div>
								</th>
...
?>
								<tr>
								<td>
									 <b><?php echo date('F-Y',strtotime($t_date)); ?></b>
								</td>
