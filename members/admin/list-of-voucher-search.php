...
?>
<?php
$dateObj   = DateTime::createFromFormat('!m', $monid);
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>List of Vouchers
                                    <div class="page-title-subheading">List of Vouchers for <?php echo $monthName; ?>-<?php echo $yeaid; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">List of Vouchers for <?php echo $monthName; ?>-<?php echo $yeaid; ?></h5>
...
$monid =$_REQUEST['month_id'];
  $yeaid =$_REQUEST['year_id'];
$sql = "SELECT `voucher`.*, `bank_account`.`bank_name` FROM `voucher`,`bank_account` WHERE voucher.bank_id=bank_account.bank_id HAVING MONTH(date) = $monid and YEAR(date) = $yeaid ORDER BY date";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
			echo '';
