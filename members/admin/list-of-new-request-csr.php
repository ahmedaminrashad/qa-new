            ...
            <!-- App inner start-->
                ...
                <!-- Page Title Start-->
                                ...
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-new-request"><div class="widget-numbers text-success"><span><?php echo type("1"); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-2">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-responded-request"><div class="widget-numbers text-primary"><span><?php echo type("6"); ?></span></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-2">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-allocated-request"><div class="widget-numbers text-warning"><span><?php echo type("7"); ?></span></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-2">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-later-request"><div class="widget-numbers text-danger"><span><?php echo type("10"); ?></span></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-2">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-archives-request"><div class="widget-numbers text-danger"><span><?php echo type("2"); ?></span></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-2">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-right">
                                            <a href="list-of-new-request-teaching"><div class="widget-numbers text-danger"><span><?php echo type("3"); ?></span></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
						...
						<?php 
// sending query
$sql = "SELECT * FROM new_request WHERE status = $csr_status AND csr_id = $csr_id ORDER BY request_id DESC";
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
			echo '';
