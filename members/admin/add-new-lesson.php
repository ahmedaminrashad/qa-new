...
$page_subtitle = 'You are adding a Lesson!';
$table_name = 'Add Lesson';
?>
                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"><?php $table_name; ?></h5>
                                    <form id="signupForm" class="col-md-10 mx-auto" name="f1" action="add-new-lesson?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" name="cmdSubmit" value="Sign up">Add Lesson</button>
                                </div>
                            </form>
                                </div>
                            </div>
