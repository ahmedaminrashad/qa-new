...
?>
								...
								<td>
									 <div class="ml-auto badge badge-success" title="Taken Regular"><?php echo classes("$Course_ID", "$pT", "$mm_id", "$yy_id", "9"); ?></div>-<div class="ml-auto badge badge-info" title="Leave"><?php echo classes("$Course_ID", "$pT", "$mm_id", "$yy_id", "5"); ?></div>-<div class="ml-auto badge badge-danger" title="Absent"><?php echo classes("$Course_ID", "$pT", "$mm_id", "$yy_id", "4"); ?></div>-<div class="ml-auto badge badge-warning" title="Pending"><?php echo classes("$Course_ID", "$pT", "$mm_id", "$yy_id", "7"); ?></div>-<div class="ml-auto badge badge-success" title="Classes/Week"><?php echo schedule_classes($Course_ID); ?></div>
								</td>
								<td>
								...
								<td><a class="add" href="#invoice" data-toggle="modal" data-target="#invoice" teacher-id="<?php echo $pT; ?>" student-id="<?php echo $Course_ID; ?>" name="<?php echo $course_yrSec; ?>"><div class="ml-auto badge badge-success" title="Add Extra Class"><i class="fa fa-history"></i></div></a>
								</td>
								<td>
								    <a href="list-of-reports?course=<?php echo $Course_ID; ?>"><div class="ml-auto badge badge-success" title="Reports">Reports</div></a>
								</td>
							</tr>
							<?php 	
		}
