...
$result = mysqli_query($mysql, "SELECT `invoice`.*, `currency`.`currency_name` FROM `invoice`,`currency` WHERE invoice.currency_id=currency.currency_id HAVING py_id = '$in_id'");
