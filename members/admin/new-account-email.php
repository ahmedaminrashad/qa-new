...
$puser =$_REQUEST['user'];
$ppass =$_REQUEST['pass'];
$pparent_id =$_REQUEST['parent_id'];
$mail->addAddress($pemail, $pname);
    $time_start = date(" g:i:A", time());
                  ...
                  <tr>
                    <td align="center" valign="top" style="padding: 0 20px;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 22px; font-weight: 400;color: #302f35;">Welcome to '.$site_nameC.'.</td> 
                        </tr>
                        <tr> 
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                ...
                                It is our honor and pleasure to have you in our online web-portal. To know your Schedule, Course, Class History, Lesson, Learning Recourse and Lesson Pages, just login by using following credentials:<br><br><strong>Login Link: </strong>https://www.'.$site_nameS.'/members/accounts
                                ...
                                Our staff will be more than willing to assist you with your needs. Here at www.'.$site_nameS.'.com, your support and convenience is always our top most priority.<br><br>
...
<strong>Admin '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email1.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
    ...
    echo "<script>window.open('parent-accounts-profile?parent_id=".$pparent_id."','_self')</script>";
