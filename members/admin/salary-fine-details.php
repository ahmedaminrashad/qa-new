...
<div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Adjustemnt Details</h5>
            ...
            <div class="modal-body">
                <table class="mb-0 table">
								...
								<?php 
// sending query
$sql = "SELECT * FROM teacher_fine WHERE teacher_id = $famID AND date >= '$famMonth' AND date <= '$famYear' AND type IN ($famType)";
$counter = 0;
