...
$page_subtitle = 'Edit Image';
$table_name = 'Edit Image';
?>
                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"><?php $table_name; ?></h5>
										<form id="signupForm" class="col-md-10 mx-auto" method="post" action="edit-course-image?c_id=<?php echo $cid; ?>&cname=<?php echo $cname; ?>">
												<div class="form-group">
															<label></label>
															<div>
																<img src="../uploads/<?php echo $img; ?>"  height="50%" width="50%" alt=""/>	
														</div>
													</div>
												<div class="form-group">
															<label>Image*</label>
