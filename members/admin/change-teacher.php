...
if (isset($_POST['cmdSubmit'])) 
  	...
  	$link =$_REQUEST['link'];
			$con_c= $_POST['c_id'];
			$con_t= $_POST['pteacher'];

			$sql = "UPDATE course SET Teacher = '$con_t' where course_id = '$con_c'"; 
			if ($conn->query($sql) === TRUE) {
			echo '';
			}
			$sql = "UPDATE sched SET Teacher = '$con_t' where course_id = '$con_c'";
			if ($conn->query($sql) === TRUE) {
...
?>
<?php
$page_title = 'Change Teacher';
$page_subtitle = 'Change Teacher';
$table_name = 'Change Teacher';
?>
            ...
            <!-- App inner start-->
				...
				while ($row = mysqli_fetch_assoc($result)){  ?>
                      ...
                      <?php } ?>
												...
												<input type="hidden" value="<?php echo $$Course_ID; ?>" name="c_id" id="c_id" class="form-control input-circle">
											<div class="form-group">
