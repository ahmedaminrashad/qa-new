...
$sql = "SELECT * FROM `reports` WHERE course_id = '$ccc' ORDER BY date DESC";
$counter = 0;
...
?>
								...
								<td>
									 <a href="report-details?ID=<?php echo $Report_ID; ?>"><button class="mb-2 mr-2 btn btn-shadow btn-success btn-sm">See Report</button></a>
								</td>
								<td>
									 <a href="delete-report?ID=<?php echo $Report_ID; ?>"><button class="mb-2 mr-2 btn btn-shadow btn-danger btn-sm">Delete Report</button></a>
								</td>
								<td>
									 <a href="edit-report?ID=<?php echo $Report_ID; ?>&link=<?php echo $link; ?>"><button class="mb-2 mr-2 btn btn-shadow btn-warning btn-sm">Edit Report</button></a>
								</td>
								<td>
									 <?php if ($status == 1) { echo '<a href="approve-report?ID='.$Report_ID.'"><button class="mb-2 mr-2 btn btn-shadow btn-danger btn-sm">Approve Report</button></a>'; } 
									 else { echo '<div class="badge badge-success">Approved</div>'; } ?>
								</td>
							</tr>
							<?php 		
		}
