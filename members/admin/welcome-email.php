                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                ...
                                <br><br>Thank you for registering to the Arabic programs at '.$site_nameC.'. This is a courtesy follow up email to make sure you have received your log in information. If you have not received them, please let us know.
                                <br><br>To help you get started, we are pleased to offer you a trial class with one of our professional native teachers. According to your preferences in the registration form, you shall tell us your available date and time. Please confirm your available date and time in order to proceed with booking your trial class and provide you with the teachers contact info.  Here is our Skype id ('.$skype_zoom.'),  Please add us to connect you with the teacher.
                                <br><br>Jazak Allahu khayran for your interest in '.$site_nameC.'. We ask Allah that he grants us all the ability to understand His Book and to give us sincerity. Amin.
...
<strong>Admin '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email1.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
            ...
            <tr>
              <td width="600" align="center" valign="top">
                <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 12px; mso-line-height-rule: exactly; line-height: 18px; font-weight: 400;color: #a1b4c4;">www.'.$site_nameS.'</td>
                  </tr>
                </table>
              </td>
            </tr>
