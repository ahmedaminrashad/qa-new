...
$result = mysqli_query($mysql, "SELECT * FROM profile Where (cat_id = 8 OR  teacher_rights = 1) AND active = 1 AND g_id = 2 AND inout_id = 1 AND schedule_status = 1 AND training = 1");
//$result = mysqli_query($mysql, "SELECT * FROM profile Where teacher_id = '1'");
