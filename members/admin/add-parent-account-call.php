...
$sql = "SELECT * FROM account WHERE email = '$pemail'";
...
if ($numberOfRows > 0) 
			...
			$test_name = $row['parent_name'];
			$note = '<div class="alert alert-danger">* An account with email <b>' . $test_email. '</b> already exist in database with name <b>' . $test_name. '</b></div>';
			}
			}
elseif ($numberOfRows == 0){
			$sql = "INSERT INTO account(parent_name, email, username, userpass, c_id, telephone, mobile, skype, fee, city, m_id, currency_id, mode_id, date, belong, timezone, trial_date, csr_id, invoice_type, payment_cycle, group_id, rate)
				...
				$sql = "INSERT INTO new_request(name, status, csr_id, message, date)
					VALUES('$pname','5','$ID','From Call','$pd')";
                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" maxlength="16" value="" name="pname" id="pname" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <input type="email" class="form-control" value="" name="pemail" id="pemail" required>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" value="" name="pname1" id="pname1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" value="" name="pname3" id="pname3">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" value="" name="pname4" id="pname4" required>
                                    </div>
                                </div>
                                </div>
