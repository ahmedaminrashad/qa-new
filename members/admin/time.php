...
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<div class="ml-auto badge badge-success">'.$new_date.'</div>'; ?> <div class="ml-auto badge badge-success">Admin Home</div></h5>
						...
						<table class="align-middle mb-0 table table-hover">								<thead>
								<tr>
								<th>
									 A-Time
								</th>
								...
								<?php
// sending query
   $sql = "SELECT * FROM `class_history` WHERE date_admin = '$data_date' and start_time_A <= '$time_id' and end_time_A > '$time_id' ORDER BY start_time_A";
$result = mysqli_query($conn, $sql);
