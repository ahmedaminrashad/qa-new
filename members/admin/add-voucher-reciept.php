...
?>
<?php
$page_title = 'Add Receipt Voucher';
$page_subtitle = 'You are adding a Receipt Voucher!';
$table_name = 'Add Receipt Voucher';
?>
...
<div class="app-main__outer">
            ...
            <!-- App inner start-->
                ...
                <!-- App inner end -->
<?php echo $footer; ?>	form.bank_id.value = ("<?php echo '1'; ?>");
