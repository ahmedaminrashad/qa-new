...
<?php
	...
	$sql = "UPDATE test_results SET tajweed_marks = '$tajweed_results', reading_marks = '$read', hifz_marks = '$manzil', mistakes = '$actual_mistakes', taken_date_admin = '$tdate', status_id = '2', teacher_p = '$tgrade', taken_by = '1' WHERE test_id = '$t_id'"; 
