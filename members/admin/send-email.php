...
$subjectp =$_REQUEST['subjectp'];
$namep =$_REQUEST['namep'];
$emailp =$_REQUEST['emailp'];
$textp =$_REQUEST['textp'];
$emailSA =$_REQUEST['emailSA'];
$pid =$_REQUEST['pid'];
if ($emailSA == $email_info) { $aemail = $email_info; $apass = $email_pass_info; }
elseif ($emailSA == $email_accounts) { $aemail = $email_accounts; $apass = $email_pass_accounts; }
else { $aemail = $email_sched; $apass = $email_pass_sched; }
...
$mail->Password = $apass;
$mail->setFrom($aemail, $company_name_sched);
$mail->addReplyTo($aemail, $company_name_sched);
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">We hope you are doing well.<br><br></td> 
                                    </tr> 
                                    <tr>
                                      <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;">'.$textp.'</td> 
                                    </tr>
                                  	<!-- #{BeginInfo} -->
                                  	<!-- #{EndInfo} -->                                    
                                  </table>
                              ...
                              <tr>
                                ...
                                If you have any question or query in this regard, you can contact us anytime. We are avaialable 24/7 at your service.<br><br>Jazakallah Khairan<br><br>
<strong>'.$site_nameC.'</strong>
                                <br><br><br>Admin '.$site_nameC.'<br>
<strong>Schedule '.$site_nameC.'</strong><br>www.'.$site_nameS.'<br>E-mail:'.$email3.'<br>'.$skype_zoom.'<br>Phone:<br>'.$phone1.''.$phone2.''.$phone3.'   
                                </td>
                              </tr>
                            </table>
                          </td>
