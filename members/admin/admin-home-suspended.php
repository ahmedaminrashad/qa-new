...
$page_subtitle = 'List of all classes suspended today!';
$table_name = 'CLasses';
?>
...
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<div class="ml-auto badge badge-success">'.$new_date.'</div>'; ?> <div class="ml-auto badge badge-success">Suspended</div></h5>
								...
								<th>
									 &nbsp;
                                            ...
                                            <?php 
// sending query
$sql = "SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND status = 17 ORDER BY start_time_A";
$counter = 0;
$result = mysqli_query($conn, $sql);
