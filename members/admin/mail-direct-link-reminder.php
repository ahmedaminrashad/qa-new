...
$naccount = mb_strlen($account, 'UTF-8');
$nfee = mb_strlen($fee, 'UTF-8');
$nfammon = mb_strlen($row['parent_name'].'-for-'.$m.'-'.$y.'-Email-Reminder', 'UTF-8');
$secret = 'jameela';
$string = ''.$naccount.''.$account.''.$nfee.''.$fee.''.$nfammon.''.$row['parent_name'].'-for-'.$m.'-'.$y.'-Email-Reminder11107product';
                              ...
                              <tr>
                                <td align="center" valign="top">
                                  <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr> 
                                      <td colspan="2" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 20px; font-weight: 400;color: #302f35;"><br><a href="https://'.$site_nameS.'/member-area/accounts/direct-payment-link?py_id='.base64_encode($in_id).'" ><button class="button" style="vertical-align:middle"><span><b>PAY NOW</b></span></button></a></td>
                                    </tr>
                                  	<!-- #{EndInfo} -->                                    
                                  </table>
                                </td>
