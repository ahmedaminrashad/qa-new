...
$page_subtitle = 'List of all classes marked absent today!';
$table_name = 'CLasses';
?>
...
$result = mysqli_query($conn, $sql);			  	
				do {  ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h2 class="card-title"><?php $old_date_timestamp = strtotime($data_date);
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<div class="ml-auto badge badge-success">'.$new_date.'</div>'; ?> <div class="ml-auto badge badge-success">Absent Today</div></h2>
								...
								<th>
									 &nbsp;
                                            ...
                                            <?php 
// sending query
$sql = "SELECT * FROM `class_history` WHERE date_admin = '$data_date' AND monitor_id = 4 ORDER BY start_time_A";
$counter = 0;
$result = mysqli_query($conn, $sql);
