...
{
require ("../includes/dbconnection.php");
$sql = "SELECT course_id FROM course WHERE c_id = '$var'";
$counter = 0;
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
{
require ("../includes/dbconnection.php");
$sql = "SELECT course_id FROM course WHERE c_id = '$var' AND g_id = '$g' AND nature = '$a'";
$counter = 0;
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
{
require ("../includes/dbconnection.php");
$sql = "SELECT course_id FROM course WHERE c_id = '$var' AND nature = '$a'";
$counter = 0;
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
