                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div><?php echo $page_title; ?>
                                    <div class="page-title-subheading"><?php echo $page_subtitle; ?> for <?php echo $year; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Total Receipts for <?php echo $year; ?></h5>
								...
								<?php 
// sending query
$sql = "SELECT * FROM account_entry WHERE (ac_cat_id = 3 OR ac_cat_id = 4 OR ac_cat_id = 6) AND YEAR(date) = $year GROUP BY account_head";
$counter = 0;
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
?>
					...
					<!-- Table Row Start-->
                        <div class="col-lg-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Total Payments for <?php echo $year; ?></h5>
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-striped table-hover">
								<thead>
								<tr>
								...
								<?php 
// sending query
$sql = "SELECT * FROM account_entry WHERE (ac_cat_id = 2 OR ac_cat_id = 7 OR ac_cat_id = 8 OR ac_cat_id = 9 OR ac_cat_id = 1 OR ac_cat_id = 10 OR ac_cat_id = 11) AND YEAR(date) = $year GROUP BY account_head";
$counter = 0;
$result = mysqli_query($conn, $sql);
$numberOfRows = mysqli_num_rows($result);
		if ($numberOfRows == 0){
...
$('.notes').click(function(){
    ...
    $.ajax({url:"entry-details-year.php?famID="+famID+"&famValue="+famValue+"&famMonth="+famMonth+"&famYear="+famYear+"&famnn="+famnn,cache:false,success:function(result){
