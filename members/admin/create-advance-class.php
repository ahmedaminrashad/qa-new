...
$teacher =$_REQUEST['teacher'];
  $date =$_REQUEST['date'];
  $day =$_REQUEST['day'];
$sql = "DELETE FROM class_history WHERE status < 19 AND monitor_id = 1 AND date_admin = '$date' AND teacher_id = '$teacher'";
if ($conn->query($sql) === TRUE) {
    $sql = "SELECT * FROM sched WHERE aday_id = '$day' AND teacher_id = '$teacher'";
