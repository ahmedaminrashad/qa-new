                                            ...
                                            <div class="grid-menu grid-menu-3col">
                                                <div class="no-gutters row">
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-all?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-primary"><i class="lnr-laptop-phone btn-icon-wrapper"> </i>Total <?php $sql = "SELECT * FROM class_history WHERE date_admin = '$date_id'";
$result = mysqli_query($conn, $sql);
$tnumberOfRows = mysqli_num_rows($result);
echo $tnumberOfRows; ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-taken-classes?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-success"><i class="lnr-thumbs-up btn-icon-wrapper"> </i>Taken <?php echo today("$date_id", "9"); ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-remaining-classes?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-secondary"><i class="lnr-redo btn-icon-wrapper"> </i>Remaining <?php echo today("$date_id", "1"); ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-absents?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-danger"><i class="lnr-neutral btn-icon-wrapper"> </i>Absent <?php echo today("$date_id", "4"); ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-leaves?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-warning"><i class="lnr-highlight btn-icon-wrapper"> </i>Leave <?php echo today("$date_id", "5"); ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-running-classes?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-info"><i class="lnr-bicycle btn-icon-wrapper"> </i>Runing <?php echo today("$date_id", "3"); ?></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <div class="grid-menu grid-menu-3col">
                                                <div class="no-gutters row">
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-declined?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-danger"><i class="lnr-sad btn-icon-wrapper"> </i>Declined <?php echo today("$date_id", "6"); ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-suspended?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-danger"><i class="lnr-hand btn-icon-wrapper"> </i>Suspended <?php $sql = "SELECT * FROM class_history WHERE date_admin = '$date_id' AND status = 17";
$result = mysqli_query($conn, $sql);
$tnumberOfRows = mysqli_num_rows($result);
echo $tnumberOfRows; ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-on-trial?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-warning"><i class="lnr-history btn-icon-wrapper"> </i>Trials <?php $sql = "SELECT * FROM class_history WHERE date_admin = '$date_id'AND status = 11";
$result = mysqli_query($conn, $sql);
$tnumberOfRows = mysqli_num_rows($result);
echo $tnumberOfRows; ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-advance?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-info"><i class="pe-7s-graph1 btn-icon-wrapper"> </i>Advance <?php $sql = "SELECT * FROM class_history WHERE date_admin = '$date_id' AND status = 19";
$result = mysqli_query($conn, $sql);
$tnumberOfRows = mysqli_num_rows($result);
echo $tnumberOfRows; ?></button></a>
                                                    </div>
                                                    <div class="col-sm-6 col-xl-4">
                                                        <a href="admin-home-rescheduled?date=<?php echo $date_id; ?>"><button class="btn-icon-vertical btn-square btn-transition btn btn-outline-warning"><i class="lnr-clock btn-icon-wrapper"> </i>Re-Scheduled <?php $sql = "SELECT * FROM class_history WHERE date_admin = '$date_id' AND status = 20";
$result = mysqli_query($conn, $sql);
$tnumberOfRows = mysqli_num_rows($result);
echo $tnumberOfRows; ?></button></a>
                                                    </div>
...
$result = mysqli_query($conn, $sql);			  	
				do {  ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"><?php $old_date_timestamp = strtotime($date_id);
$new_date = date('l jS F-Y', $old_date_timestamp); echo '<div class="ml-auto badge badge-success">'.$new_date.'</div>'; ?> <div class="ml-auto badge badge-success">Admin Home</div></h5>
								...
								<?php
// sending query
$sql = "SELECT * FROM `class_history` WHERE date_admin = '$date_id' and start_time_A <= '$time_id' and end_time_A > '$time_id' ORDER BY start_time_A";
$counter = 0;
$result = mysqli_query($conn, $sql);
