<?php
/**
 * Bespecialteam functions and definitions
 *
 * 
 */
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'index-js', get_template_directory_uri() . '/assets/js/index.js', array( 'jquery' ), $theme_version, true );
...
function twentytwenty_menus() {
	...
	$locations = array(
		'quick'  => __( 'Quick Links', 'twentytwenty' ),
		'copyrights'   => __( 'Copyright Menu', 'twentytwenty' ),
		'adultsmenu'   => __( 'Courses for Adults', 'twentytwenty' ),
		'kidsmenu'   => __( 'Courses for Kids', 'twentytwenty' ),
	);
...
function twentytwenty_sidebar_registration() {
	...
	$shared_args = array(
		'before_title'  => '<h3 class="text-yellow">',
		'after_title'   => '</h3>',
		'before_widget' => '',
		'after_widget'  => '',
	);
